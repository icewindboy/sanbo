...
*
* @author kangning.hu
* @createtime 2009-6-6 上午10:17:55
*
 */
public class InfowarelabPlaceHolder extends PropertyPlaceholderConfigurer {
    ...
    private String convert2UrlFormat(String originalPlaceholderToUse) {
        ...
        int startIndex = buf.indexOf(InfowarelabPlaceHolder.PREFIX);
        while (startIndex != -1) {
