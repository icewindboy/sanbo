...
public final class BuyGoodsSelect extends BaseAction implements Operate
{
  ...
  public static BuyGoodsSelect getInstance(HttpServletRequest request)
  {
    ...
    synchronized (session)
    {
      ...
      if(buyGoodsSelectBean == null)
      {
        ...
        buyGoodsSelectBean = new BuyGoodsSelect();
        buyGoodsSelectBean.user = loginBean.getUser();
        buyGoodsSelectBean.fgsid = loginBean.getFirstDeptID();
  ...
  class Init implements Obactioner
  {
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      ...
      String SQL = combineSQL(IMPORT_BUY_JHD_SQL, "?", new String[]{user.getHandleDeptWhereValue("deptid", "czyid"),fgsid," "});
      if(!dwxid.equals(""))
      {
        dwtxid = dwxid;
