...
public final class B_BuyBalance extends BaseAction implements Operate
{
  ...
  private static final String COLLECT_SQL = "SELECT sum(nvl(a.je,0))zje,sum(nvl(a.hxje,0))zhxje,sum(nvl(a.zfkje,0)-nvl(a.hxje,0))totalWhxje FROM cw_cgjs a WHERE a.dwtxid=? and a.personid=? GROUP BY a.dwtxid";//汇总
