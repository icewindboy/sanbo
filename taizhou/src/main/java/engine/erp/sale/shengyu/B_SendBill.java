...
public final class B_SendBill extends BaseAction implements Operate
{
  ...
  public  static final String LADING_OUT_TWO     = "1111015";//出库确认校验
  ...
  public  static final String DELETE_BLANK      = "1022225";
  public  static final String DETAIL_DELETE_BLANK      = "211022225";
  ...
  private static final String DETAIL_SQL            = " SELECT a.*,b.zxh from xs_tdhw a, (SELECT e.wjid,e.zxh from xs_tdhw d, kc_sfdjmx e WHERE d.tdhwid=e.wjid AND e.djxz=2 and d.tdid='?' ) b,kc_dm c WHERE a.tdhwid=b.wjid(+) AND a.cpid=c.cpid and a.tdid='?' order by b.zxh,c.cpbm";//
  ...
  public static B_SendBill getInstance(HttpServletRequest request)
  {
    ...
    synchronized (session)
    {
      ...
      if(b_SendBillBean == null)
      {
        ...
        b_SendBillBean.dsDetailTable.setColumnFormat("jje", b_SendBillBean.sumFormat);
        b_SendBillBean.dsDetailTable.setColumnFormat("xsje", b_SendBillBean.sumFormat);
  ...
  private final void jbInit() throws java.lang.Exception
  {
    ...
    addObactioner(String.valueOf(DETAIL_DELETE_BLANK), new Delete_Blank());
  }
  /**
   * JSP调用的函数
  ...
  private final void initRowInfo(boolean isMaster, boolean isAdd, boolean isInit) throws java.lang.Exception
  {
    ...
    if(isMaster){
      ...
      else
      {
        ...
        m_RowInfo.put("zt", "0");
        String tdbh = dataSetProvider.getSequence("SELECT pck_base.billNextCode('xs_td','tdbh') from dual");
