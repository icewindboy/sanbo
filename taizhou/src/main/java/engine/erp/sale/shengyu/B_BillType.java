...
public final class B_BillType extends BaseAction implements Operate
{
  ...
  public static B_BillType getInstance(HttpServletRequest request)
  {
    ...
    synchronized (session)
    {
      ...
      if(billTypeBean == null)
      {
        ...
        session.setAttribute(beanName, billTypeBean);//加入到session中
      }
    }
    return billTypeBean;
  }
  ...
  protected void jbInit() throws Exception
  {
    ...
    dsB_OrderType.setSequence(new SequenceDescriptor(new String[]{"funditemid"}, new String[]{"s_xs_fund_item"}));//设置主健的sequence
    //添加操作的触发对象
