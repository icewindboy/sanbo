          ...
          if(rowInfo.get("zt").equals("1"))
          {
            ...
            for(int i=0;i<d_RowInfos.size();i++)
            {
              ...
              if(shijixs11!=null&&!shijixs11.equals(""))
              {
                ...
                double wcbL11 = Double.parseDouble(shijixs11)/Double.parseDouble(khxs11)*110;
              ...
              if(shijixs12!=null&&!shijixs12.equals(""))
              {
                ...
                double wcbL12 = Double.parseDouble(shijixs12)/Double.parseDouble(khxs12)*120;
      ...
      */
      ...
      class Master_Post implements Obactioner
      {
        public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
        {
          ...
          if((String.valueOf(CONFIRM_RETURN).equals(action))||(String.valueOf(POST).equals(action)))
        ...
        private String checkDetailInfo()
        {
          ...
          for(int i=0; i<d_RowInfos.size(); i++)
          {
            ...
            if((temp = checkNumber(khxs69, "6月考核销售")) != null)
              return temp;
            String khxs10 = detailrow.get("khxs10");
            if((temp = checkNumber(khxs10, "6月考核销售")) != null)
              return temp;
            String khxs11 = detailrow.get("khxs11");
            if((temp = checkNumber(khxs11, "6月考核销售")) != null)
              return temp;
            String khxs12 = detailrow.get("khxs12");
            if((temp = checkNumber(khxs12, "6月考核销售")) != null)
              return temp;
          }
          return null;
        }
