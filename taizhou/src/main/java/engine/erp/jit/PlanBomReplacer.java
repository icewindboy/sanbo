...
public final class PlanBomReplacer extends BaseAction implements Operate
{
   ...
   */
  public static PlanBomReplacer getInstance(HttpServletRequest request)
  {
    PlanBomReplacer planBomReplaceBean = null;
    HttpSession session = request.getSession(true);
    synchronized (session)
    {
      String beanName = "planBomReplaceBean";
      planBomReplaceBean = (PlanBomReplacer)session.getAttribute(beanName);
      if(planBomReplaceBean == null)
      {
        LoginBean loginBean = LoginBean.getInstance(request);
        planBomReplaceBean = new PlanBomReplacer();
        planBomReplaceBean.qtyFormat = loginBean.getQtyFormat();
        planBomReplaceBean.dsBomReplace.setColumnFormat("sl", planBomReplaceBean.qtyFormat);
        session.setAttribute(beanName, planBomReplaceBean);
      }
    }
