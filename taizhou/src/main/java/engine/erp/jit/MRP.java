...
public final class MRP extends BaseAction implements Operate
{
  ...
  private static final String DETAIL_SQL    = "SELECT * FROM sc_wlxqjhmx sc_wlxqjhmx,  xs_ht xs WHERE sc_wlxqjhmx.htid = xs.htid(+) and sc_wlxqjhmx.wlxqjhid='?' ORDER BY xs.htbh";//
   ...
   */
  public static MRP getInstance(HttpServletRequest request)
  {
    MRP mrpBean = null;
    ...
    synchronized (session)
    {
      ...
      mrpBean = (MRP)session.getAttribute(beanName);
      if(mrpBean == null)
      {
        //引用LoginBean
  ...
  private final void jbInit() throws java.lang.Exception
  {
    ...
    dsDetailTable.setTableName("sc_wlxqjhmx");
