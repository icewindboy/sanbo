package engine.erp.report.sale;
    ...
    /**
     * <p>Title: 销售发票汇总帐</p>
     * <p>Description: 销售发票汇总帐</p>
     * <p>Copyright: Copyright (c) 2003</p>
     * <p>Company: </p>
     * @version 1.0
     */
    public class B_SaleFPCollect implements ReportDataLoadedListener
    {

      public B_SaleFPCollect()
      {
      }
      public void dataLoaded(ServletRequest parm1, TempletData parm2, ContextData parm3, EngineDataSet parm4)
      {
        ...
        String ksrq = where.getWhereValue("a$kprq$a");//查询条件开始日期
        String jsrq = where.getWhereValue("a$kprq$b");//查询条件结束日期
