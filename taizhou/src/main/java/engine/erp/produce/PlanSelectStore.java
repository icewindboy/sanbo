...
{
  private static final String IMPORT_ORDER_SQL = "SELECT * FROM VW_PRODUCEPLAN_SEL_STORE ";
  ...
  class Init implements Obactioner
  {
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      ...
      dsPlanSelectStore.setQueryString(IMPORT_ORDER_SQL);
