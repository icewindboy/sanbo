...
public final class B_ApproveDefine extends BaseAction implements Operate
{
  ...
  private final void openDetailTable(boolean isMasterAdd)
  {
    ...
    dsDetailTable = new EngineDataSet();
  ...
  private final void openSPRDetailTable()
  {
    ...
    {
      dsSPRTable.close();
      setDataSetProperty(dsSPRTable,SQL);
      dsSPRTable.open();
    }
    else
    {
      dsSPRTable = new EngineDataSet();
      setDataSetProperty(dsSPRTable,SQL);
      dsSPRTable.open();
    }
  }
  ...
  class Detail_Add implements Obactioner
  {
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      ...
      spxmmxID = dataSetProvider.getSequence("S_SP_XMMX");
      dsDetailTable.setValue("spxmmxID", spxmmxID);
  ...
  class Detail_SPR_Post implements Obactioner
  {
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      ...
      {
        detailrow = (RowMap)spr_RowInfos.get(i);
        dsSPRTable.setValue("spxmmxID", detailrow.get("spxmmxID"));//
        dsSPRTable.setValue("personid", detailrow.get("personid"));//
        dsSPRTable.setValue("deptid", detailrow.get("deptid"));//
        dsSPRTable.next();
      }
      dsSPRTable.post();
      dsSPRTable.saveChanges();
    }
  ...
  class Detail_Delete implements Obactioner
  {
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      EngineDataSet ds = dsDetailTable;
      //ds.refresh();
      int rownum = Integer.parseInt(data.getParameter("rownum"));
      ds.goToRow(rownum);
      ...
      */
      ...
      setDataSetProperty(tmp,SPR_SQL+spxmmxID);
      tmp.open();
      tmp.deleteAllRows();
      ...
      ds.deleteRow();
      ds.saveDataSets(new EngineDataSet[]{ds, tmp}, null);
