...
%><%
  ...
  InbuyOrderBean.doService(request, response);
  EngineDataSet list = InbuyOrderBean.getDetailTable();
  synchronized(list){
    if(list.changesPending())
      InbuyOrderBean.openDetailTable(false);
    ...
    //engine.project.LookUp salePriceBean = InbuyOrderBean.getSalePriceBean(request);
%>
<html>
<head>
<title></title>
