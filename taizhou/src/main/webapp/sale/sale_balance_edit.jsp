...
<script language="javascript">
  ...
  function formatSum(srcStr){ return formatNumber(srcStr, '<%=loginBean.getSumFormat()%>');}
    ...
    function selctTDHWOfLading()
    {
      ...
      TdhwMultiSelect('form1','srcVar=tdhwids','fieldVar=tdid','&dwtxid='+form1.dwtxid.value+'&personid='+form1.personid.value,"sumitForm(<%=b_SaleBalanceBean.DETAIL_SALE_ADD%>,-1)");
        }
