...
%><%
  engine.erp.sale.B_ImportOrderToBackLading b_ImportOrderToBackLadingBean = engine.erp.sale.B_ImportOrderToBackLading.getInstance(request);
...
function showDetail(masterRow){
  ...
  parent.bottom.location.href='back_import_order_buttom.jsp?operate=<%=b_ImportOrderToBackLadingBean.EDIT%>&rownum='+masterRow;
  unlockScreenWait();
}
