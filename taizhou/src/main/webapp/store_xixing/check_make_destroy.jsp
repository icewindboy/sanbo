...
<%
/**
 * 02.19 21:00 把数量和换算数量的位置换了一下,下面的打印数据部分也做了相应的改动 yjg
 */
%>
...
%><%
  engine.erp.store.xixing.Check_Make_Destroy checkMakeDestroyBean = engine.erp.store.xixing.Check_Make_Destroy.getInstance(request);
...
function backList()
{
  location.href='../store_xixing/store_check_edit.jsp';
}
</script>
