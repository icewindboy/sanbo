  ...
  <table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="center" width="760">
    <tr valign="top">
      <td><table border=0 CELLSPACING=0 CELLPADDING=0 class="table">
        <tr>
            <td class="activeVTab">退货单(<%=title%>)</td>
          </tr>
        </table>
...
function checkdwst()
{
  ...
  */
  OrderMultiSelect('form1','srcVar=importOrder&dwtxid='+form1.dwtxid.value+'&storeid='+form1.storeid.value+'&djlx='+form1.djlx.value+'&personid='+form1.personid.value+'&jsfsid='+form1.jsfsid.value+'&khlx='+form1.khlx.value+'&sendmodeid='+form1.sendmodeid.value+'&yfdj='+form1.yfdj.value)
}
