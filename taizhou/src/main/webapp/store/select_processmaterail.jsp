<%--生产领料单引入加工单物料界面--%><%@ page contentType="text/html;charset=UTF-8"%><%@ include file="../pub/init.jsp"%>
...
%><%
  engine.erp.store.B_ImportProcessMaterail importProcessMaterailBean = engine.erp.store.B_ImportProcessMaterail.getInstance(request);
