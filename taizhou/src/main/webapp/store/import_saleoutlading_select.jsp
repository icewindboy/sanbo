...
%><%
  engine.erp.store.ImportSaleOutOrderGoods importSaleOutOrderGoodsBean = engine.erp.store.ImportSaleOutOrderGoods.getInstance(request);
  String retu = importSaleOutOrderGoodsBean.doService(request, response);
  ...
  EngineDataSet list = importSaleOutOrderGoodsBean.getOneTable();
%>
<html>
<head>
<title></title>
...
{
  sumitFixedQuery(<%=importSaleOutOrderGoodsBean.FIXED_SEARCH%>);
}
</script>
<BODY oncontextmenu="window.event.returnValue=true">
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar"><TR>
    <TD NOWRAP align="center">外贸提单货物清单</TD>
  </TR></TABLE>
    ...
    <TABLE cellspacing=3 cellpadding=0 border=0>
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:130" id="tdbh" name="tdbh" value='<%=importSaleOutOrderGoodsBean.getFixedQueryValue("tdbh")%>' onKeyDown="return getNextElement();"></TD>
              <TD align="center" nowrap class="td">产品名称</TD>
              <td nowrap class="td"><input class="EDLine" style="WIDTH:130px" name="cp_product" value='<%=prodBean.getLookupName(importSaleOutOrderGoodsBean.getFixedQueryValue("cpid"))%>' onKeyDown="return getNextElement();"readonly>
                <INPUT TYPE="HIDDEN" NAME="cpid" value="<%=importSaleOutOrderGoodsBean.getFixedQueryValue("cpid")%>">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="tdrq$a" value='<%=importSaleOutOrderGoodsBean.getFixedQueryValue("tdrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" id="tdrq$b" style="WIDTH: 130px" name="tdrq$b" value='<%=importSaleOutOrderGoodsBean.getFixedQueryValue("tdrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:130" id="cpbm" name="cpbm" value='<%=importSaleOutOrderGoodsBean.getFixedQueryValue("cpbm")%>' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>品名规格</TD>
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:130" id="product" name="product" value='<%=importSaleOutOrderGoodsBean.getFixedQueryValue("product")%>' onKeyDown="return getNextElement();"></TD>
            </TR>
          </TABLE>
      <TR>
        <TD colspan="4" nowrap class="td" align="center"><INPUT class="button" onClick="sumitFixedQuery(<%=importSaleOutOrderGoodsBean.FIXED_SEARCH%>)" type="button" title="查询(ALT+F)" value="查询(F)" name="button" onKeyDown="return getNextElement();">
