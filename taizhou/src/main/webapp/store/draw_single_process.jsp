<%--生产领料单单选生产加工单--%><%@ page contentType="text/html;charset=UTF-8"%><%@ include file="../pub/init.jsp"%>
...
%>
<%
  engine.erp.store.B_DrawSingleProcess drawSingleProcessBean = engine.erp.store.B_DrawSingleProcess.getInstance(request);
