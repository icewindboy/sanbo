...
function toDetail(){
  parent.location.href='product_wrapper_check_edit.jsp';
}
function showDetail(masterRow){
  selectRow();
  lockScreenToWait("处理中, 请稍候！");
  parent.bottom.location.href='product_wrapper_check_bottom.jsp?operate=<%=productBean.SHOW_DETAIL%>&rownum='+masterRow;
    unlockScreenWait();
}
...
function showApprove(productcheckid){
   openUrlOpt1('../pub/approve_result.jsp?operate=0&project=product_wrapper_check&id='+productcheckid);
}
</script>
<BODY oncontextmenu="window.event.returnValue=true">
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar"><TR>
    <TD NOWRAP align="center">成品纸检验报告单</TD>
  </TR></TABLE>
