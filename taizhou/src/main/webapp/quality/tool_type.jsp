...
<SCRIPT LANGUAGE="javascript">
  ...
  {
    var url = "tool_type_edit.jsp?operate="+oper+"&rownum="+rownum;
...
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar">
  <TR>
    <TD colspan="6" align="center" NOWRAP>检验器具分类</TD>
  </TR>
</TABLE>
<%
  EngineDataSet list = ToolTypeBean.getOneTable();
...
</td> <TD align="right"><%if(ToolTypeBean.retuUrl!=null){%><input name="button2222232" type="button" align="Right"
  class="button" onClick="location.href='<%=ToolTypeBean.retuUrl%>'" value=" 返回 "border="0"><%}%></TD>
    </TR>
  </TABLE>
  <table id="tableview1" width="60%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    <tr class="tableTitle">
      <td width="242" nowarp>器具分类编码</td>
      <td width="400" nowarp>器具分类名称</td>
      <td nowarp width="70">
    ...
    <tr onDblClick="showInterFrame(<%=Operate.EDIT%>,<%=list.getRow()%>)">
      <td class="td" nowarp>
      &nbsp;<%
       String toolTypeCode  = list.getValue("toolTypeCode");
          out.print(toolTypeCode);
      %>
      </td>
      <td class="td" nowarp>&nbsp;<%=list.getValue("toolTypeName")%></td>
      <td class="td" nowarp>
