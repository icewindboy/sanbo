...
%><%
  ...
  String pageCode = "product_wrapper_check";
  productBean.checkType="3";
%>
<html>
<head>
<title></title>
...
function backList()
{
  location.href='product_wrapper_check.jsp';
}
  ...
  <table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="center" width="760">
    <tr valign="top">
      <td><table border=0 CELLSPACING=0 CELLPADDING=0 class="table">
        <tr>
            <td class="activeVTab">成品纸检验报告单(<%=title%>)</td>
          </tr>
        </table>
              ...
              <table CELLSPACING="1" CELLPADDING="1" BORDER="0" width="100%" bgcolor="#f0f0f0">
                 <tr>
                  ...
                  <td colspan="3"  noWrap class="td"> <input type="hidden" name="cpid" value="<%=masterRow.get("cpid")%>">
                    ...
                    <img style='cursor:hand' src='../images/delete.gif' BORDER=0 ONCLICK="cpbm.value='';cpmc.value='';cpid.value='';">
                    <%}%>
                  </td>
                 <tr>
            ...
            <td colspan="3" noWrap class="tableTitle">
             <%if(isCanChange){%>
              ...
              <pc:shortcut key="c" script='backList();'/><%}%>
               ...
               <input type="button"  style="width:60" class="button" value="打印(P)" onclick="location.href='../pub/pdfprint.jsp?code=product_wrapper_check_bill&operate=<%=Operate.PRINT_BILL%>&a$productcheckid=<%=masterRow.get("productcheckid")%>&src=../quality/product_wrapper_check_edit.jsp'">
...
<script language="javascript">
  ...
  if(confirm('是否删除该记录？'))sumitForm(<%=Operate.DEL%>);
    ...
    function print(){
     location.href='../pub/pdfprint.jsp?code=product_wrapper_check_bill&operate=<%=Operate.PRINT_BILL%>&a$productcheckid=<%=masterRow.get("productcheckid")%>&src=../quality/product_wrapper_check_edit.jsp'
  }
  function selctbilloflading()
  {
      OrderSingleSelect('form1','srcVar=receivedetailid&srcVar=cpid&srcVar=dmsxid&srcVar=selectedtdid&srcVar=productno','fieldVar=receivedetailid&fieldVar=cpid&fieldVar=dmsxid&fieldVar=receivedetailid&fieldVar=ph','',"sumitForm(<%=productBean.PRODUCT_ADD%>,-1)",'3');
        }
