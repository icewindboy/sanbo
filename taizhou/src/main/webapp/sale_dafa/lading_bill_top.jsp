      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="tdbh$a" name="tdbh$a" value='<%=b_ladingbillBean.getFixedQueryValue("tdbh$a")%>' maxlength='16' onKeyDown="return getNextElement();"></TD>
              <TD nowrap class="td">--</TD>
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="tdbh$b" name="tdbh$b" value='<%=b_ladingbillBean.getFixedQueryValue("tdbh$b")%>' maxlength='16' onKeyDown="return getNextElement();"></TD>
              </tr>
              <tr>
            ...
            <tr>
             ...
             <td width="120" class="td">
              <%String isnet = b_ladingbillBean.getFixedQueryValue("isnet");%>
