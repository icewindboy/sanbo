...
<%
  ...
  if(!loginBean.hasLimits(pageCode, request, response))
    return;
  engine.erp.sale.dafa.B_SalerPrize B_SalerPrizeBean = engine.erp.sale.dafa.B_SalerPrize.getInstance(request);
...
{
  paraStr = "saler_prize_detail.jsp?operate=0&jjzbid="+jjzbid+"&personid="+personid;
...
<TR>
    <TD NOWRAP align="center">业务员奖金2</TD>
</TR>
</TABLE>
