...
%>
<%
  engine.erp.jit.MRPSelectPlan mrpSelectBean = engine.erp.jit.MRPSelectPlan.getInstance(request);
  String pageCode = "mrp";
  ...
  String retu = mrpSelectBean.doService(request, response);
  ...
  EngineDataSet list = mrpSelectBean.getOneTable();
%>
<html>
<head>
<title></title>
