...
function backList()
{
  location.href='../person/train_plan.jsp';
}
</script>
...
<table cellspacing="2" cellpadding="0" border="0" width="100%" bgcolor="#f0f0f0">
    ...
    <INPUT TYPE="HIDDEN" NAME="personid"  VALUE="<%=m_RowInfo.get("personid")%>">
     <tr>
       ...
       <td nowrap class="td"><input type="text" name="pxbh" value='<%=m_RowInfo.get("pxbh")%>' maxlength="10" style="width:50" <%=typeClass%> onKeyDown="return getNextElement();" <%=readonly%>></td>
