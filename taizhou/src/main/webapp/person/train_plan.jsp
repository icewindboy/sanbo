...
<%
  ...
  if(!loginBean.hasLimits(pageCode, request, response))
    return;
  engine.erp.person.B_TrainPlan B_TrainPlanBean = engine.erp.person.B_TrainPlan.getInstance(request);
        ...
        <TR>
          <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
             ...
             <td nowrap class="td">
             <pc:select name="fzbm" addNull="1" style="width:131">
             <%=deptBean.getList(B_TrainPlanBean.getFixedQueryValue("fzbm"))%>
              </pc:select>
             </td>
            ...
            <%--TR>
              ...
              <a href="#"><img src="../images/seldate.gif" width="20" height="16" border="0" title="选择日期" onClick="selectDate(pxsj);"></a></td>
             <td nowrap class="tdTitle">负责部门</td>
             <td nowrap class="td">
             <pc:select name="deptid" addNull="1" style="width:131">
             <%=deptBean.getList(B_TrainPlanBean.getFixedQueryValue("deptid"))%>
              </pc:select>
             </td>
            </TR--%>
          <TR>
