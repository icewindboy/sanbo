...
<form name="form1" action="<%=curUrl%>" method="POST" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table  BORDER="0" cellpadding="1" cellspacing="3">
    ...
    <tr>
     ...
     <tr>
      <td noWrap colspan="3" class="td"><input type="hidden" name="jsgs" value="<%=row.get("jsgs")%>" style="WIDTH:325" maxlength="<%=ds.getColumn("jsgs").getPrecision()%>" class="ednone" readonly>
      </td>
     </tr>
    <tr>
