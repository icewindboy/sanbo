...
<%
  ...
  String djandjjeClass = canedt ?"class=edFocused_r": "class=edline" ;
  ...
  <table class="editformbox" CELLSPACING=1 CELLPADDING=0 >
        ...
        <tr>
          ...
          <tr>
                  ...
                  <td noWrap class="tdTitle">回笼天数</td>
                  <td noWrap class="td">
      ...
      <tr>
                ...
                <td  noWrap class="td">
                  ...
                  <td noWrap class="tdTitle">回笼日期</td>
      ...
      <tr>
                ...
                <td   noWrap class="td">
                   <input type="text" name="yfdj" value='<%=masterRow.get("yfdj")%>' maxlength='10' style="width:110" <%=djandjjeClass%> onChange="yfdjonchange()" onKeyDown="return getNextElement();"  <%=canedt?"":" readonly"%> >
                </td>
...
function checkdwst()
  ...
  OrderMultiSelect('form1','srcVar=importOrder&dwtxid='+form1.dwtxid.value+'&storeid='+form1.storeid.value+'&djlx='+form1.djlx.value+'&personid='+form1.personid.value+'&khlx='+form1.khlx.value+'&jsfsid='+form1.jsfsid.value+'&sendmodeid='+form1.sendmodeid.value+'&yfdj='+form1.yfdj.value+'&isnet=<%=masterRow.get("isnet")%>')
}
function OrderMultiSelect(frmName, srcVar, methodName,notin)
{
  ...
  paraStr = "../sale_dafa/import_order.jsp?operate=0&srcFrm="+frmName+"&"+srcVar;
  if(methodName+'' != 'undefined')
    paraStr += "&method="+methodName;
  if(notin+'' != 'undefined')
    paraStr += "&notin="+notin;
