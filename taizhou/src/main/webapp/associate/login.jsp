...
<p align="right">&nbsp;&nbsp;&nbsp;</td>
          ...
          <td width="54%" height="163" valign="top" rowspan="2">
            <form name="form1" method="POST" action="dologin.jsp" onSubmit="return false;">
              ...
              <table border="0" width="103%">
                ...
                <tr>
                  <td width="47%" class="tdTitle"><div align="right">公 司 ID：</div></td>
                  <td width="53%"><input type="text" name="dwdm" size="14" value="<%=loginBean.getDwdm()%>" maxlength="32">
                  </td>
                </tr>
                <tr>
        ...
        <tr>
          <td height="14" colspan="2" align="right" valign="top">
            <font color="#0000FF">台州三博科技有限公司&nbsp;&nbsp;版权所有 2005-2010</font>
          </td>
        </tr>
      </table>
    </td>
