<%@ page contentType="text/html; charset=utf-8" %><%@ page import = "java.math.BigDecimal"%><%request.setCharacterEncoding("utf-8");
  ...
  String retu = engine.common.OtherLoginBean.doPost(request, response);
  ...
  if(loginBean.isLogin())
  {
    ...
    show.append("var newwin = window.open('").append( request.getContextPath()+"/associate/pub/engine.jsp");
