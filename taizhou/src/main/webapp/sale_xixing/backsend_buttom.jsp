...
<%
  ...
  synchronized(b_BackBillBean){
    b_BackBillBean.doService(request, response);
    EngineDataSet list = b_BackBillBean.getDetailTable();
    HtmlTableProducer detailProducer = b_BackBillBean.detailProducer;//从表表格生成器
    list.first();
  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <%
      if(list.changesPending())
        b_BackBillBean.openDetailTable(b_BackBillBean.masterIsAdd());
