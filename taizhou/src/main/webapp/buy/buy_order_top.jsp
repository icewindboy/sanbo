...
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar"><TR>
    <TD NOWRAP align="center">采购合同列表</TD>
  </TR></TABLE>
         ...
         <%=deptBean.getList(buyOrderBean.getFixedQueryValue("deptid"))%></pc:select>
            ...
            <TR>
              <TD align="center" nowrap class="td">产品名称</TD>
               <td nowrap class="td" colspan="3"><input class="EDLine" style="WIDTH:330px" name="product" value='<%=buyOrderBean.getFixedQueryValue("product")%>' onKeyDown="return getNextElement();"readonly>
                <INPUT TYPE="HIDDEN" NAME="htid" value="<%=buyOrderBean.getFixedQueryValue("htid")%>"><img style='cursor:hand' src='../images/view.gif' border=0 onClick="ProdSingleSelect('fixedQueryform','srcVar=htid&srcVar=product','fieldVar=cpid&fieldVar=product',fixedQueryform.htid.value)">
            ...
            <TR>
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:130" id="htid$product" name="htid$product" value='<%=buyOrderBean.getFixedQueryValue("htid$product")%>' onKeyDown="return getNextElement();"></TD>
            </TR>
            <TR>
