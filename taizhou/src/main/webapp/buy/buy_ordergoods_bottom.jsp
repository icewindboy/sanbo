...
<%
  ...
  buyOrderGoodsBean.doService(request, response);
  EngineDataSet list = buyOrderGoodsBean.getDetailTable();
  synchronized(list){
    if(list.changesPending())
      buyOrderGoodsBean.openDetailTable(false);
  ...
  //engine.project.LookUp salePriceBean = buyOrderGoodsBean.getSalePriceBean(request);
