...
%><%
  engine.erp.store.shengyu.B_ReceiveMaterial receiveMaterailBean = engine.erp.store.shengyu.B_ReceiveMaterial.getInstance(request);
  ...
  <%String retu = receiveMaterailBean.doService(request, response);
    ...
    EngineDataSet list = receiveMaterailBean.getMaterListTable();
    HtmlTableProducer table =null;
    if(SC_OUTSTORE_SHOW_ADD_FIELD.equals("1"))
      table = receiveMaterailBean.masterListProducer;
    else
      table = receiveMaterailBean.newmasterListProducer;
