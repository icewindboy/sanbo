 ...
 * <p>             此页面被放到了putoutlist_bottom.jsp主框架网页的下方框架内.</p>
...
<%
  ...
  if(!loginBean.hasLimits(pageCode, request, response))
    return;
  engine.erp.store.shengyu.B_OutSaleStore saleOutStoreBean = engine.erp.store.shengyu.B_OutSaleStore.getInstance(request);
  synchronized(saleOutStoreBean){
    ...
    engine.project.LookUp saleOrderGoodsBean = engine.project.LookupBeanFacade.getInstance(request, engine.project.SysConstant.VW_BEAN_XPORT_LADING_DETAIL);//引入销售提单
