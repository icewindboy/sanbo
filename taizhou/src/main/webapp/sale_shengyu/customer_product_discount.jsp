     ...
     <%
      ...
      <TD align="right">
        <INPUT class="button" onClick="tobachadd(<%=b_customerproductdiscountBean.BATCHINIT%>)" type="button" value="批量增加(Q)" name="Query" onKeyDown="return getNextElement();">
         ...
         <INPUT class="button" onClick="tobachadd(<%=b_customerproductdiscountBean.BATCHEDIT%>,-1)" type="button" value="批量修改(E)" name="Query" onKeyDown="return getNextElement();">
         <pc:shortcut key="e" script='<%="sumitForm("+b_customerproductdiscountBean.BATCHEDIT+"))"%>' />
      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            ...
            <TR>
                ...
                <INPUT class="edbox" style="WIDTH:260" id="product" name="product" value='<%=b_customerproductdiscountBean.product%>' maxlength='220' onKeyDown="return getNextElement();"  onchange="productNameSelect(this)">
             ...
             <TR>
              <td align="center" nowrap class="td">价格</td>
              <td class="td" nowrap>
              ...
              <INPUT class="edbox"  style="WIDTH: 60px" name="dj$b" value='<%=b_customerproductdiscountBean.getFixedQueryValue("dj$b")%>'  onKeyDown="return getNextElement();">
              </td>
            </TR>
            <TR>
              <TD nowrap class="td">报价日期</TD>
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="ksrq$a" value='<%=b_customerproductdiscountBean.getFixedQueryValue("ksrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="ksrq$b" value='<%=b_customerproductdiscountBean.getFixedQueryValue("ksrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
                <A href="#"><IMG title=选择日期 onClick="selectDate(ksrq$b);" height=20 src="../images/seldate.gif" width=20 align=absMiddle border=0></A></TD>
            </TR>
            <tr>
              <td nowrap class="td">是否历史报价</td>
               <td nowrap class="td">
               <%
               String sflsbj = b_customerproductdiscountBean.getFixedQueryValue("sflsbj");
               %>
               <input type=RADIO name="sflsbj" value='' <%=sflsbj.equals("") ? " checked" : ""%>>全部&nbsp;
               <input type=RADIO name="sflsbj" value='1' <%=sflsbj.equals("1")? " checked" : ""%>>是&nbsp;
               <input type=RADIO name="sflsbj" value='0' <%=sflsbj.equals("0") ? " checked" : ""%>>否
               </TD>
            </tr>
            </TABLE>
            <TR>
