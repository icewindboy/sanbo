...
%><%
  engine.erp.finance.xixing.B_wjgdhwList b_wjgdhwListBean = engine.erp.finance.xixing.B_wjgdhwList.getInstance(request);//创建实例
  String retu = b_wjgdhwListBean.doService(request, response);
  ...
  EngineDataSet list = b_wjgdhwListBean.getOneTable();
  ...
  String wldw=request.getParameter("dwtxid");
%>
<html>
<head>
<title></title>
...
<TR>
    <TD NOWRAP align="center">外加工单明细</TD>
</TR>
</TABLE>
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <%RowMap prodRow = prodBean.getLookupRow(list.getValue("cpid"));%>
      <td nowrap align="center" class="td"><input type="checkbox" name="sel" value='<%=list.getValue("jgdmxid")%>' onKeyDown="return getNextElement();"></td>
      <input type="hidden" id="jgdmxid_<%=i%>" value='<%=list.getValue("jgdmxid")%>'>
      <td nowrap onClick="checkRadio(<%=i%>)" id="jgdh_<%=i%>" class="td"><%=list.getValue("jgdh")%></td>
      ...
      <td nowrap onClick="checkRadio(<%=i%>)" id="jgdj_<%=i%>" class="td"><%=list.getValue("jgdj")%></td>
    ...
    <TABLE cellspacing=3 cellpadding=0 border=0>
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              <TD nowrap class="td">加工单明细</TD>
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="jhdbm" name="jgdmxid" value='<%=b_wjgdhwListBean.getFixedQueryValue("jgdmxid")%>' maxlength='10' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>加工单位</TD>
              <TD nowrap class="td">
                <%if(wldw.equals("")){%>
                <input type="hidden" name="dwtxid" value='<%=b_wjgdhwListBean.getFixedQueryValue("dwtxid")%>'>
                <input type="text" name="buyerName" value='<%=b_wjgdhwListBean.getFixedQueryValue("buyerName")%>' style="width:130" class="edline" readonly>
            ...
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="rq$a" value='<%=b_wjgdhwListBean.getFixedQueryValue("rq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="jhrq$b" value='<%=b_wjgdhwListBean.getFixedQueryValue("jhrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <%=deptBean.getList(b_wjgdhwListBean.getFixedQueryValue("deptid"))%></pc:select>
              </TD>
             </TR>
            <TR>
            <TR>
