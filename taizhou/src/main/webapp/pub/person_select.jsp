...
// return;
String retu="";
engine.erp.person.B_PersonBean B_PersonBeanBean = engine.erp.person.B_PersonBean.getInstance(request);
...
if(operate !=null && operate.equals(String.valueOf(Operate.INIT)))
{
  ...
  retu = B_PersonBeanBean.doService(request, response);
}
if(operate !=null && operate.equals(String.valueOf(Operate.FIXED_SEARCH)))
{
  ...
  EngineDataSet list = B_PersonBeanBean.getOneTable();
  ...
  if(String.valueOf(Operate.PROD_CHANGE).equals(operate)|| String.valueOf(Operate.PROD_NAME_CHANGE).equals(operate))
  {
    ...
    String fieldValue=B_PersonBeanBean.code_name_Change(bm,name,operate,isdelete);
    if(fieldValue.equals("more")){
      ...
      out.print("parent.SingleSelectperson('"+srcFrm+"','"+srcVar+"','"+fVar+"','"+methodName+"','"+bm+"','"+name+"')");
    }
      ...
      out.print("parent."+srcFrm+"."+inputName[2]+".value='';");
        ...
        String xmbm=equipmentRow.get("bm");
        out.print("parent."+srcFrm+"."+inputName[0]+".value='"+fieldValue+"';");
        out.print("parent."+srcFrm+"."+inputName[1]+".value='"+xmbm+"';");
  ...
  <div class="queryPop" id="fixedQuery" name="fixedQuery">
    ...
    <table border="0" cellpadding="0" cellspacing="3">
      ...
      <tr>
        ...
        <td noWrap class="td"><input type="text" name="bm" value='<%=B_PersonBeanBean.getFixedQueryValue("bm")%>' style="width:180" class="edbox"></td>
      </tr>
      <tr>
        <td noWrap class="td" align="center">&nbsp;员工姓名&nbsp;</td>
        <td noWrap class="td"><input type="text" name="xm" value='<%=B_PersonBeanBean.getFixedQueryValue("xm")%>' style="width:180" class="edbox"></td>
      </tr>
      <tr>
        <td noWrap class="td" align="center">部门</td>
        <td noWrap class="td"><pc:select name="deptid" addNull="1" style="width:180">
            <%=deptBean.getList(B_PersonBeanBean.getFixedQueryValue("deptid"))%></pc:select></td>
      </tr>
      <tr>
        <td colspan="2" noWrap align="center" height="30"><input name="button" type="button" class="button" onClick="sumitFixedQuery(<%=B_PersonBeanBean.FIXED_SEARCH%>);" value=" 查询 ">
