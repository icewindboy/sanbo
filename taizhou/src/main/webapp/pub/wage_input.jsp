...
<form name="form1" method="post" action="<%=curUrl%>"  onsubmit="return false;" onKeyDown="return onInputKeyboard();">
  ...
  <TABLE width="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 align="center">
    ...
    <td class="td" nowrap> <pc:dbNavigator dataSet="<%=key%>" pageSize="<%=pageSize%>"/> </td>
        ...
        <td class="td" >
        <pc:select name="month" style="width:50" value="<%=b_WageInputBean.getMonth()%>" onSelect="<%=t%>">
      ...
      <%--<input name="button" type="button" class="button" onClick="sumitForm(<%=b_WageInputBean.CITE%>);" value="引计件工资(R)">
      <pc:shortcut key="r" script="<%=sav%>" />--%>
      <%}%>
      <%}%>
        ...
        <TD>
            <TABLE cellspacing=3 cellpadding=0 border=0>
             ...
             <TR>
                  ...
                  <td class="td" nowrap>
                    <pc:select name="gzkxzbID$nf" input="0" addNull="0" style="width:80" >
                    ...
                    <td>
                    <pc:select name="gzkxzbID$yf" addNull="1"  input="0" style="width:130" >
      ...
      <TR>
        <TD>
            ...
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="startdate" value='' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD align="center" nowrap class="td">--</TD>
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="enddate" value='' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
