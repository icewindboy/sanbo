...
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar"><TR>
    <TD NOWRAP align="center">银行帐号列表</TD>
  </TR></TABLE>
<%String retu = accountBean.doService(request, response);
  ...
  EngineDataSet list = accountBean.getOneTable();
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tableview1" width="760" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <COLGROUP valign="middle">
    <COLGROUP valign="middle">
    <COLGROUP width=100 valign="middle" align="center">
    ...
    <tr onDblClick="showInterFrame(<%=Operate.EDIT%>,<%=i%>)">
      <td class="td"><%=bankBean.getLookupName(list.getValue("yhid"))%></td>
      <td class="td"><%=list.getValue("zh")%></td>
      <td class="td"><%=list.getValue("zhmc")%></td>
      <td class="td"><%=list.getValue("zhlx").equals("1") ? "现金帐户" : "银行帐户"%></td>
  ...
  {
    var url = "bankaccountedit.jsp?operate="+oper+"&rownum="+rownum;
  ...
  <TABLE cellspacing=0 cellpadding=0 border=0>
    <TR>
      <TD><iframe id="interframe1" src="" width="328" height="300" marginWidth="0" marginHeight="0" frameBorder="0" noResize scrolling="no"></iframe>
      </TD>
    </TR>
  </TABLE>
</div>
