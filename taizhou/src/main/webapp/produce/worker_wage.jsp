...
function toDetail(){
  location.href='workload_wage.jsp';
}
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();">
  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <tr id="tr_<%=list.getRow()%>" onDblClick="sumitForm(<%=Operate.EDIT%>,<%=list.getRow()%>)">
      <td  align="center" nowrap><input name="image2" class="img" type="image" title="查看" onClick="sumitForm(<%=Operate.EDIT%>,<%=list.getRow()%>)" src="../images/edit.gif" border="0"> </td>
      ...
      <td class="td" align="right" nowrap><%=list.getValue("cqhz")%></td>
      <td class="td" align="right" nowrap><%=list.getValue("rbhz")%></td>
      <td class="td" align="right" nowrap><%=list.getValue("ybhz")%></td>
      <td class="td" align="right" nowrap><%=list.getValue("qjhz")%></td>
      <td class="td" align="right" nowrap><%=list.getValue("jjgzhz")%></td>
      <td class="td" align="right"nowrap><%=list.getValue("jehz")%></td>
    </tr>
    <%  list.next();
      }
      for(; i < loginBean.getPageSize()-1; i++){
    %>
     <tr>
