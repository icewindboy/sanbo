...
%><%
  ...
  workloadWorkerBean.doService(request, response);
  EngineDataSet list = workloadWorkerBean.getDetailTable();
  synchronized(list){
    if(list.changesPending())
      workloadWorkerBean.openDetailTable(false);
    ...
    //engine.project.LookUp salePriceBean = workloadWorkerBean.getSalePriceBean(request);
%>
<html>
<head>
<title></title>
