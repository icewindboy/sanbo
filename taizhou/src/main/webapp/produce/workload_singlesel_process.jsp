<%--工人工作量单选加工单主表--%><%@ page contentType="text/html;charset=UTF-8"%><%@ include file="../pub/init.jsp"%>
...
%>
<%
  engine.erp.produce.B_WorkLoad_Sel_Process singleSelectProcessBean = engine.erp.produce.B_WorkLoad_Sel_Process.getInstance(request);
  ...
  String retu = singleSelectProcessBean.doService(request, response);
  ...
  EngineDataSet list = singleSelectProcessBean.getOneTable();
%>
<html>
<head>
<title></title>
