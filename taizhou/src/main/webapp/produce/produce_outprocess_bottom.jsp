...
%><%
  ...
  produceOutProcessBean.doService(request, response);
  EngineDataSet list = produceOutProcessBean.getDetailTable();
  //System.out.println("RowCount:"+list.getRowCount());
  synchronized(list){
    if(list.changesPending())
      produceOutProcessBean.openDetailTable(false);
    //System.out.println("RowCount:"+list.getRowCount());
    ...
    //engine.project.LookUp salePriceBean = produceOutProcessBean.getSalePriceBean(request);
%>
<html>
<head>
<title></title>
...
<form name="form1" action="" onsubmit="return false;" onKeyDown="return onInputKeyboard();">
  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <tr>
      ...
      <td class="td" nowrap><%=list.getValue("jgdj")%></td>
      <td class="td" nowrap><%=list.getValue("jgje")%></td>
    </tr>
      <%list.next();
      }
      i=count+1;
