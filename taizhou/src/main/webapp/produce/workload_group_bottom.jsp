...
<%@ page import="com.borland.dx.dataset.DataSet"%><%
  ...
  workloadGroupBean.doService(request, response);
  EngineDataSet list = workloadGroupBean.getDetailTable();
  synchronized(list){
    if(list.changesPending())
      workloadGroupBean.openDetailTable(false);
    HtmlTableProducer detailProducer = workloadGroupBean.detailProducer;
%>
<html>
<head>
<title></title>
