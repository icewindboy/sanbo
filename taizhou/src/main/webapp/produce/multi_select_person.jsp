...
%>
<%
  engine.erp.produce.Select_Person Select_PersonBean = engine.erp.produce.Select_Person.getInstance(request);
  ...
  String retu = Select_PersonBean.doService(request, response);
  ...
  EngineDataSet list = Select_PersonBean.getOneTable();
      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD class="td" nowrap>
              <input type='txt' class="edbox" name="xm" value='<%=Select_PersonBean.getFixedQueryValue("xm")%>' style='width:110'  >
              </TD>
             </TR>
            <TR>
            <TR>
