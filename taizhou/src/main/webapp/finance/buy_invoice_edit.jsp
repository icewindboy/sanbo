          ...
          <tr>
            <td colspan="3" noWrap class="tableTitle">
             ...
             <pc:shortcut key="i" script="impot()"/>
              ...
              <%}%>
              <%}%>
              <input type="button"  style="width:60" class="button" value="打印(P)" onclick="location.href='../pub/pdfprint.jsp?code=buy_invoice_edit_bill&operate=<%=Operate.PRINT_BILL%>&a$cgfpid=<%=masterRow.get("cgfpid")%>&src=../finance_shengyu/buy_invoice_edit.jsp'">
...
function print()
{
   location.href='../pub/pdfprint.jsp?code=buy_invoice_edit_bill&operate=<%=Operate.PRINT_BILL%>&a$cgfpid=<%=masterRow.get("cgfpid")%>&src=../finance_shengyu/buy_invoice_edit.jsp'
}
//产品编码
