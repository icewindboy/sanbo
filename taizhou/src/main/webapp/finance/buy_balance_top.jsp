      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            ...
            <TR>
              ...
              <td noWrap class="td"><input type="text" name="je$a" value='<%=b_BuyBalanceBean.getFixedQueryValue("je$a")%>' maxlength='50' style="width:131" class="edbox"></td>
              <td noWrap class="td" align="center">--</td>
              <td noWrap class="td"><input type="text" name="je$b" value='<%=b_BuyBalanceBean.getFixedQueryValue("je$b")%>' maxlength='50' style="width:131" class="edbox"></td>
            </TR>
            <TR>
              <td noWrap class="td" align="center">单据号</td>
              <td noWrap class="td"><input type="text" name="djh$a" value='<%=b_BuyBalanceBean.getFixedQueryValue("djh$a")%>' maxlength='50' style="width:131" class="edbox"></td>
              <td noWrap class="td" align="center">--</td>
              <td noWrap class="td"><input type="text" name="djh$b" value='<%=b_BuyBalanceBean.getFixedQueryValue("djh$b")%>' maxlength='50' style="width:131" class="edbox"></td>
            </TR>
            <TR>
