...
%><%
  engine.erp.finance.BuyGoodsSelect buyGoodsSelectBean = engine.erp.finance.BuyGoodsSelect.getInstance(request);//创建实例
      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="jhdbm" name="jhdbm" value='<%=buyGoodsSelectBean.getFixedQueryValue("jhdbm")%>' maxlength='10' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>供货单位</TD>
              <TD nowrap class="td">
                <%if(wldw.equals("")){%>
                <input type="hidden" name="dwtxid" value='<%=buyGoodsSelectBean.getFixedQueryValue("dwtxid")%>'>
                <input type="text" name="buyerName" value='<%=buyGoodsSelectBean.getFixedQueryValue("buyerName")%>' style="width:130" class="edline" readonly>
            ...
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="jhrq$a" value='<%=buyGoodsSelectBean.getFixedQueryValue("jhrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="jhrq$b" value='<%=buyGoodsSelectBean.getFixedQueryValue("jhrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <%=deptBean.getList(buyGoodsSelectBean.getFixedQueryValue("deptid"))%></pc:select>
              </TD>
             </TR>
            <TR>
            <TR>
