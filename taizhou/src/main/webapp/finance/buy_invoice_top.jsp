    ...
    <TABLE cellspacing=3 cellpadding=0 border=0>
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160"  name="fphm" value='<%=b_BuyInvoiceBean.getFixedQueryValue("fphm")%>' maxlength='100' onKeyDown="return getNextElement();"></TD>
              <TD nowrap class="td">发票号码</TD>
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="sjhm" name="sjhm" value='<%=b_BuyInvoiceBean.getFixedQueryValue("sjhm")%>' maxlength='100' onKeyDown="return getNextElement();"></TD>
              </tr>
              <tr>
            ...
            <TR>
              ...
              <TD nowrap class="td">
                <pc:select name="fplbid" addNull="1"  style="width:110">
                <%=invoiceTypeBean.getList(b_BuyInvoiceBean.getFixedQueryValue("fplbid"))%>
                </pc:select>
              </TD>
             </TR>
              ...
              <TD class="td" nowrap>
              <INPUT class="edbox" style="WIDTH:160" id="personid$xm" name="personid$xm" value='<%=b_BuyInvoiceBean.getFixedQueryValue("personid$xm")%>' maxlength='16' onKeyDown="return getNextElement();">
             </TD>
              <tr>
