package engine.erp.finance.widesky;
 ...
 */
  ...
  {
    public  static final String SHOW_DETAIL = "1110901";
    public  static final String DETAIL_SALE_ADD = "1110801";
    public  static final String TD_RETURN_ADD = "1144444";//提单退货新增
    public  static final String DWTXID_CHANGE = "11348881";
    public  static final String CANCER_APPROVE = "10235131";
    public  static final String JHDHW = "77665544";//采购单购货
    public  static final String REPORT    = "55555343";
    public  static final String INVOICE_OVER = "34235131";//完成
    ...
    private static final String MASTER_SUM_SQL    = "SELECT SUM(nvl(zsl,0))zsl FROM cw_cgfp WHERE 1=1 AND ? AND fgsid=? ?  ";
    private static final String MASTER_JE_SQL    = "SELECT SUM(nvl(zje,0))zje FROM cw_cgfp WHERE 1=1 AND ? AND fgsid=? ?  ";
    ...
    public static B_BuyInvoice getInstance(HttpServletRequest request)
    {
      ...
      synchronized (session)
      {
        ...
        if(b_BuyInvoiceBean == null)
        {
          ...
          b_BuyInvoiceBean.dsDetailTable.setColumnFormat("gsl", b_BuyInvoiceBean.qtyFormat);
          b_BuyInvoiceBean.dsDetailTable.setColumnFormat("gs", b_BuyInvoiceBean.sumFormat);
    ...
    private final void jbInit() throws java.lang.Exception
    {
      ...
      String pref = "CG";
      dsMasterTable.setSequence(new SequenceDescriptor(new String[]{"fphm"}, new String[]{"SELECT pck_base.fieldNextCode('cw_cgfp','fphm','"+ pref +"','',6) from dual"}));
   ...
   return zzje;
    ...
    private final void putDetailInfo(HttpServletRequest request)
    {
      ...
      for(int i=0; i<rownum; i++)
      {
        ...
        detailRow.put("gsl", rowInfo.get("gsl_"+i));
        detailRow.put("gs", rowInfo.get("gs_"+i));
    ...
    class Init implements Obactioner
    {
      public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
      {
        ...
        //
        String SQL=" ";
        String MSSQL = combineSQL(MASTER_SQL, "?", new String[]{user.getHandleDeptWhereValue("deptid", "czyid"), fgsid, SQL});

        dsMasterTable.setQueryString(MSSQL);
   ...
   class Master_Add_Edit implements Obactioner
   {
     public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
     {
       ...
       if(String.valueOf(EDIT).equals(action))
       {
         ...
         masterRow = dsMasterTable.getInternalRow();
         cgfpid= dsMasterTable.getValue("cgfpid");//关链
         fpzl= dsMasterTable.getValue("fpzl");
       }
       else{
         isMasterAdd=true;
         fpzl=String.valueOf(ADD).equals(action)?"2":"1";//1=增值税，2=企业普票
       }
    ...
    class Master_Post implements Obactioner
    {
      public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
      {
        ...
        for(int i=0; i<detail.getRowCount(); i++)
        {
          ...
          double zjshj = detailrow.get("jshj").length() > 0 ? Double.parseDouble(detailrow.get("jshj")) : 0;
          zje = zje+zjshj;
          zsl = zsl+sl;
          ...
          detail.setValue("gsl", detailrow.get("gsl"));
          detail.setValue("gs", detailrow.get("gs"));
          ...
          totalSum = totalSum.add(detail.getBigDecimal("jshj"));
          detail.next();
        }
        //保存主表数据
        ...
        ds.setValue("fpzl", rowInfo.get("fpzl"));//发票种类
        ...
        ds.setValue("zje", String.valueOf(zje));//
        ds.setValue("fgsid", fgsid);//分公司
        //保存用户自定义的字段
      ...
      private String checkDetailInfo()
      {
        ...
        for(int i=0; i<d_RowInfos.size(); i++)
        {
          ...
          if((temp = checkNumber(wsdj, detailProducer.getFieldInfo("wsdj").getFieldname())) != null)
            return temp;
          String gsl = detailrow.get("gsl");
          if((temp = checkNumber(gsl, detailProducer.getFieldInfo("gsl").getFieldname())) != null)
            return temp;
    ...
    class Master_Search implements Obactioner
    {
      public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
      {
        ...
        String MSSQL = combineSQL(MASTER_SQL, "?", new String[]{user.getHandleDeptWhereValue("deptid", "czyid"), fgsid, SQL});//组装SQL语句
        if(!dsMasterTable.getQueryString().equals(MSSQL))
        {
          dsMasterTable.setQueryString(MSSQL);
          dsMasterTable.setRowMax(null);
        }
      ...
      private void initQueryItem(HttpServletRequest request)
      {
        ...
        fixedQuery.addShowColumn("", new QueryColumn[]{
          new QueryColumn(master.getColumn("fphm"), null, null, null, "a", ">="),//
          new QueryColumn(master.getColumn("fphm"), null, null, null, "b", "<="),
          new QueryColumn(master.getColumn("sjhm"), null, null, null, "a", ">="),//发票号码
          new QueryColumn(master.getColumn("sjhm"), null, null, null, "b", "<="),
          ...
          new QueryColumn(master.getColumn("fpzl"), null, null, null, null, "="),
    ...
    class Detail_Add_Null implements Obactioner
    {
      public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
      {
        ...
        dsDetailTable.setValue("zzsl", "17");
        dsDetailTable.post();
      ...
      public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
      {
        ...
        for(int i=0; i < jhdhwids.length; i++)
        {
          ...
          if(!dsDetailTable.locate(locateGoodsRow, Locate.FIRST))
          {
            ...
            double wsdj = hsdj/1.17;
            double se = Double.parseDouble(saleRow.get("sl").equals("")?"0":saleRow.get("sl"))*wsdj*0.17;
            ...
            dsDetailTable.setValue("je", String.valueOf(wsdj*sl));
