...
public final class B_SaleBalance extends BaseAction implements Operate
{
  ...
  private static final String COLLECT_SQL = "SELECT sum(nvl(a.je,0))zje,sum(nvl(a.hxje,0))zhxje,sum(nvl(a.je,0)-nvl(a.hxje,0))totalWhxje FROM cw_xsjs a WHERE a.dwtxid=? and a.personid=? GROUP BY a.dwtxid";//汇总
  ...
  private static final String AUTO_CANCER_SQL = "SELECT * FROM vw_sale_balance where 1=1 and dwtxid=? and personid=? and khlx='?' ORDER BY tdrq";
 ...
 class Master_Add_Edit implements Obactioner
 {
  ...
  class Detail_Auto_Cancer implements Obactioner
  {
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      ...
      String SQL = combineSQL(AUTO_CANCER_SQL,"?",new String[]{dwtxid,personid,khlx});
