package engine.erp.report.person;
...
public class B_EmployeeWage implements TempletAfterProvideListener
{
                                  ...
                                  ContextData context, TempletProvideResponse templetRes)
  {
    ...
    dsFieldTable.setQueryString("select * from rl_gzkxsz ORDER BY PXH");
