...
/**
 * <p>Title: 生产:工人工资明细 </p>
 * <p>Description: 生产:工人工资明细 </p>
 * <p>Copyright: Copyright (c) 2005</p>
 * <p>Company: </p>
 * @version 1.0
 */

public class B_WorkWageDetail implements ReportDataLoadingListener
{
  private Hashtable fieldTable = new Hashtable();
  //数据来源表示提单
  private static final String MASTER_SQL    =
      "select * from ("
      + " SELECT xm,mc,rq,gzzmc,deptid,personid,SUM(nvl(work_wage,0))work_wage, "
      ...
      + "  FROM VW_SC_WORKLOAD t WHERE 1=1 {startdate} {enddate} {mc} {gzzmc} {xm}  {pid} GROUP BY xm,mc,rq,deptid,personid,gzzmc ORDER BY deptid,rq,xm,gzzmc"
      + ")t {advance} ";
  /**
