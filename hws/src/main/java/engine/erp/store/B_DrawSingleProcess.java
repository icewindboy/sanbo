...
public final class B_DrawSingleProcess extends BaseAction implements Operate
{
  ...
  private static final String SINGLE_PROCESSMATERAIL_SQL = "SELECT DISTINCT d.jgdid,d.deptid, d.jgdh,d.describe,d.jglx,d.sfwjg,d.dwtxid,d.rq,d.zdr,d.zdrq,d.zt,d.zsl,d.fgsid,d.scjhid,d.rwdid FROM( "
   +" SELECT a.jgdid, a.cpid, a.sl,a.ylsl,a.scsl,a.ylscsl, b.storeid FROM sc_jgdwl a, kc_dm b WHERE  a.cpid=b.cpid AND (b.storeid IS NULL OR b.storeid='?') "
   +" ) c, sc_jgd d WHERE nvl(c.ylsl,0)<nvl(c.sl,0) AND c.jgdid=d.jgdid AND d.zt<>8 AND d.fgsid='?' AND (d.sfwjg IS NULL OR d.sfwjg='?') ";//生产领料单引用
