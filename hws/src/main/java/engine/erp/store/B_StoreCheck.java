        ...
        if (!(sxz_a.equals("") && sxz_b.equals("")))
        {
          ...
          if ( SQLSxzCondition )
          {
            ...
            else
            {
              ...
              if (lower_limit) lower_limit = Float.parseFloat(sxz_a) <= Float.parseFloat(tmpSQLSxz);
            }
            if (sxz_b.equals(""))
              upper_limit = true;
            else
            {
              ...
              if (upper_limit) upper_limit = Float.parseFloat(sxz_b) >= Float.parseFloat(tmpSQLSxz);
            }
            if ( !(lower_limit&&upper_limit) ) continue;
          }
