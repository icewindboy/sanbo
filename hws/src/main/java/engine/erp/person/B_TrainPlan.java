...
public final class B_TrainPlan extends BaseAction implements Operate
{
  ...
  private static final String MASTER_SQL    = "SELECT * FROM rl_pxjh where 1=1 ? ";    //对主表的参数化查询
  ...
  class Master_Search implements Obactioner
  {
    ...
    private void initQueryItem(HttpServletRequest request)
    {
      ...
      fixedQuery.addShowColumn("", new QueryColumn[]{
        ...
        //new QueryColumn(master.getColumn("pxsj"), null, null, null, null, "="),
        //new QueryColumn(master.getColumn("pxjs"), null, null, null, null, "="),
