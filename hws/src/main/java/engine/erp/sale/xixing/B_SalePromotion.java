      ...
      public static B_SalePromotion getInstance(HttpServletRequest request)
      {
        ...
        synchronized (session)
        {
          ...
          if(b_SalePromotionBean == null)
          {
            ...
            b_SalePromotionBean.dsDetailTable.setColumnFormat("jje", b_SalePromotionBean.priceFormat);
            b_SalePromotionBean.dsDetailTable.setColumnFormat("xsje", b_SalePromotionBean.priceFormat);
     ...
     public final String getZje()
     {
      ...
      //&#$
       ...
       class Add_Approve implements Obactioner
       {
         public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
         {
           ...
           approve.putAproveList(dsMasterTable, dsMasterTable.getRow(),"sale_promotion", content,deptid);
         }
      }
      /**
       * 取消审批
      ...
      class Cancer_Approve implements Obactioner
      {
        public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
        {
          dsMasterTable.goToRow(Integer.parseInt(data.getParameter("rownum")));
          ApproveFacade approve = ApproveFacade.getInstance(data.getRequest());
          approve.cancelAprove(dsMasterTable,dsMasterTable.getRow(),"sale_promotion");
        }
      }
      /**
       * 作废
     ...
     class Master_Post implements Obactioner
     {
       ...
       public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
       {
         ...
         if(isMasterAdd){
           ...
           dsMasterTable.setValue("tdrq",new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
        ...
        public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
        {
          ...
          for(int i=0; i < cpids.length; i++)
          {
            ...
            if(!dsDetailTable.locate(locateGoodsRow, Locate.FIRST))
            {
              ...
              dsDetailTable.setValue("zk", saleRow.get("100"));
