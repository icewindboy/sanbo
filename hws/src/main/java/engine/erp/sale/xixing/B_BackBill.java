...
public final class B_BackBill extends BaseAction implements Operate
{
  ...
  public  static final String MATERIAL_ON_CHANGE = "21564";//
  ...
  public static B_BackBill getInstance(HttpServletRequest request)
  {
    ...
    synchronized (session)
    {
      ...
      if(b_BackBillBean == null)
      {
        ...
        b_BackBillBean.dsDetailTable.setColumnFormat("jje", b_BackBillBean.priceFormat);
        b_BackBillBean.dsDetailTable.setColumnFormat("xsje", b_BackBillBean.priceFormat);
  ...
  private final void jbInit() throws java.lang.Exception
  {
    ...
    addObactioner(String.valueOf(MATERIAL_ON_CHANGE), new Detail_Change());
  ...
  class Master_Post implements Obactioner
  {
    ...
    public void execute(String action, Obationable o, RunData data, Object arg) throws Exception
    {
      ...
      ds.setValue("bz", rowInfo.get("bz"));//客户类型
