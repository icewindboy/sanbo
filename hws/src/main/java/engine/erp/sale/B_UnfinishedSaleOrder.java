...
public final class B_UnfinishedSaleOrder extends BaseAction implements Operate
{
  ...
  private static final String MASTER_SQL = "SELECT DISTINCT a.htbh,a.khlx,a.dwdm,a.dwmc,a.zsl,a.zje,a.xm,a.czy,a.htid,a.deptid FROM vw_sale_hthw a WHERE a.isnet=0 AND ?  AND a.fgsid=? ? ORDER BY a.htbh DESC";
      /*
