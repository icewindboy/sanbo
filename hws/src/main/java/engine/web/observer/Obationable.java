 ...
 * <p>Title: 观察者模式－触发者</p>
 * <p>Description:
 * 一个触发者对象可以有一个或多个执行者对象。 一个执行者必须实现<tt>Obactioner</tt>接口。
 * 触发者(Obationable)实例将调用执行者(<code>Obactioner</code>)的<code>notifyObactioners</code>方法
 * 此时将调用所有执行者的<code>update</code>方法.</p>
...
public class Obationable implements java.io.Serializable
{
   ...
   * @param action 以后将会触发的操作.
   * @param o      要被添加的Obactioner.
   */
   ...
   * @param action 操作行为
   */
  public final RunData notifyObactioners(String action, HttpServletRequest req, HttpServletResponse res) throws Exception
  {
   ...
   */
  public final RunData notifyObactioners(String action, HttpServletRequest req, HttpServletResponse res, Object arg) throws Exception
  {
    if(action == null)
      return null;
