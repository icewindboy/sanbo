...
<FRAMESET frameborder="0" framespacing="3" border="1" bordercolor="#f0f0e0" rows=*,160>
  <FRAME name='top' src='sale_order_top.jsp?<%=query==null ? "" : query%>' scrolling="auto">
  <FRAME id="bottom" name='bottom' src=<%=operate != null && operate.equals(init) ? request.getContextPath()+"/blank.htm" : "sale_order_bottom.jsp"%> scrolling="auto">
  <NOFRAMES>
    <body>
