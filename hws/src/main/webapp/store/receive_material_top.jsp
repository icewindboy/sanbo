...
<%String retu = receiveMaterialBean.doService(request, response);
  ...
  EngineDataSet list = receiveMaterialBean.getMaterTable();
  HtmlTableProducer table =null;
  if(SC_OUTSTORE_SHOW_ADD_FIELD.equals("1"))
    table = receiveMaterialBean.masterProducer;
  else
    table = receiveMaterialBean.newmasterProducer;
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();">
  ...
  <table id="tbcontrol" width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
    <tr>
      ...
      <td class="td" nowrap align="right">
       <%if(loginBean.hasLimits(pageCode, op_add)){%><input name="search3" type="button" class="button" onClick="sumitForm(<%=Operate.ADD%>,-1)" value="新增领料单(A)" onKeyDown="return getNextElement();">
  ...
  <table id="tableview1" width="100%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <td class="td" nowrap></td>
      ...
      <td class="td" nowrap></td>
      <td class="td" nowrap></td>
      <td class="td" nowrap><input type="text" class="ednone_r" style="width:100%" value='<%=receiveMaterialBean.getZgf()%>' readonly></td></td>
      <td class="td" nowrap></td>
      <td class="td" nowrap><input type="text" class="ednone_r" style="width:100%" value='<%=receiveMaterialBean.getZgf2()%>' readonly></td></td>
      <td class="td" nowrap></td>
      <td class="td" nowrap></td>
      <td class="td" nowrap></td>
    <%if(SC_OUTSTORE_SHOW_ADD_FIELD.equals("1")){%>
