...
<script language="javascript">initDefaultTableRow('tableview1',1);
  function onload(){
    <%=selfGainBean.adjustInputSize(new String[]{"cpbm","product", "jldw", "batchno", "drawnum","sxz", "memo","drawbignum","producenum","hsdw", "scydw"},  "form1", selfGainBean.max-min+1, min)%>
  }
  ...
  {
   location.href='../pub/pdfprint.jsp?code=self_gain_edit_bill&operate=<%=selfGainBean.PRINT_BILL%>&a$sfdjid=<%=masterRow.get("receiveid")%>&src=../store/self_gain_edit.jsp'
  }
