<%--采购入库单单选采购进货单--%><%@ page contentType="text/html;charset=UTF-8"%><%@ include file="../pub/init.jsp"%>
...
%>
<%
  engine.erp.store.B_SingleOrderGoods singleSelectOrderBean = engine.erp.store.B_SingleOrderGoods.getInstance(request);
...
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar"><TR>
    <TD NOWRAP align="center">采购进/退货单列表</TD>
  </TR></TABLE>
