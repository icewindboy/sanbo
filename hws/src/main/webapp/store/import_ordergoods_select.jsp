...
%><%
  engine.erp.store.ImportOrderGoods importOrderGoodsBean = engine.erp.store.ImportOrderGoods.getInstance(request);
  String retu = importOrderGoodsBean.doService(request, response);
  ...
  EngineDataSet list = importOrderGoodsBean.getOneTable();
%>
<html>
<head>
<title></title>
...
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar"><TR>
    <TD NOWRAP align="center">进/退货单货物清单</TD>
  </TR></TABLE>
