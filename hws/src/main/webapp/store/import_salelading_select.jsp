...
%><%
  engine.erp.store.ImportSaleOrderGoods importSaleOrderGoodsBean = engine.erp.store.ImportSaleOrderGoods.getInstance(request);
  String retu = importSaleOrderGoodsBean.doService(request, response);
  ...
  EngineDataSet list = importSaleOrderGoodsBean.getOneTable();
%>
<html>
<head>
<title></title>
...
{
  sumitFixedQuery(<%=importSaleOrderGoodsBean.FIXED_SEARCH%>);
}
</script>
    ...
    <TABLE cellspacing=3 cellpadding=0 border=0>
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:130" id="tdbh" name="tdbh" value='<%=importSaleOrderGoodsBean.getFixedQueryValue("tdbh")%>' onKeyDown="return getNextElement();"></TD>
              <TD align="center" nowrap class="td">产品名称</TD>
              <td nowrap class="td"><input class="EDLine" style="WIDTH:130px" name="cp_product" value='<%=prodBean.getLookupName(importSaleOrderGoodsBean.getFixedQueryValue("cpid"))%>' onKeyDown="return getNextElement();"readonly>
                <INPUT TYPE="HIDDEN" NAME="cpid" value="<%=importSaleOrderGoodsBean.getFixedQueryValue("cpid")%>">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="tdrq$a" value='<%=importSaleOrderGoodsBean.getFixedQueryValue("tdrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" id="tdrq$b" style="WIDTH: 130px" name="tdrq$b" value='<%=importSaleOrderGoodsBean.getFixedQueryValue("tdrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:130" id="cpbm" name="cpbm" value='<%=importSaleOrderGoodsBean.getFixedQueryValue("cpbm")%>' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>品名规格</TD>
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:130" id="product" name="product" value='<%=importSaleOrderGoodsBean.getFixedQueryValue("product")%>' onKeyDown="return getNextElement();"></TD>
            </TR>
          </TABLE>
      <TR>
        <TD colspan="4" nowrap class="td" align="center"><INPUT class="button" onClick="sumitFixedQuery(<%=importSaleOrderGoodsBean.FIXED_SEARCH%>)" type="button" title="查询(ALT+F)" value="查询(F)" name="button" onKeyDown="return getNextElement();">
