...
{
  location.href='lading_bill_print.jsp?operate=<%=b_ladingbillBean.WRAPPER_PRINT%>';
}
//输入购货单位代码
          ...
          <tr>
            <td colspan="3" noWrap class="tableTitle">
             ...
             %>
              ...
              %>
             <%--<input name="btnback" type="button" class="button" onClick="sumitForm(<%=b_ladingbillBean.WRAPPER_PRINT%>);" value=" 打印 ">--%>
