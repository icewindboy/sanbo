        ...
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            ...
            <TR>
              <TD class="td" nowrap>规格属性</TD>
                <TD nowrap class="td"> <input type="text" class="edbox" style="width:70"  name="sfdjid$sxz" onKeyDown="return getNextElement();" value='<%=saleOutStoreBean.getFixedQueryValue("sfdjid$sxz")%>'>
                </TD>
              </TD>
            </TR>
