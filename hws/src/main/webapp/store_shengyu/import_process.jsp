<%--自制收货单单选生产加工单--%><%@ page contentType="text/html;charset=gb2312"%><%@ include file="../pub/init.jsp"%>
...
%>
<%
  engine.erp.store.shengyu.B_ImportProcess b_importProcess = engine.erp.store.shengyu.B_ImportProcess.getInstance(request);
  ...
  if(operate !=null && operate.equals(String.valueOf(Operate.INIT)))
  {
    ...
    String tmpisout = request.getParameter("isout");
    isout = tmpisout != null?tmpisout:"0";
  }
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;">
  ...
  <table id="tableview1" width="90%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <%//prodBean.regData(list,"cpid");
      ...
      int i=0;
      for(; i<count; i++){
       String ss = list.getValue("dwtxid");
       String s =  corpBean.getLookupName(ss);
    %>
