...
%>
<%
if(!loginBean.hasLimits("store_assist_material_collect", request, response))
    return;
  ...
  engine.project.LookUp storeBean = engine.project.LookupBeanFacade.getInstance(request,engine.project.SysConstant.BEAN_STORE_BOTH);//engine.project.SysConstant.BEAN_STORE_BOTH

  String retu = B_StoreAssistantMaterialCollectBean.doService(request, response);//src=../pub/main.jsp(初始化函数取值)
  ...
  RowMap[] xsdsrows = B_StoreAssistantMaterialCollectBean.getXsRowinfos();
...
{
  location.href='store_assist_material_collect_print.jsp';
}
//客户名称
...
<tr class="tableTitle">
    <td align="center" valign="middle" class="td" class="tdTitle" style="font-size:18">仓库辅助材料收发存汇总表</td>
</tr>
<tr>
        ...
        <TD>
         <TABLE cellspacing=3 cellpadding=0 border=0>
          <TR>
            ...
            <TD class="td" nowrap>
             <pc:select name="storeid" addNull="1" style="width:160">
            <%=storeBean.getList(B_StoreAssistantMaterialCollectBean.getFixedQueryValue("storeid"))%></pc:select>
            </TD>
          </TR>
           ...
           <TR>
              ...
              <TD class="td" nowrap>
               <INPUT class="edbox" style="WIDTH: 130px" name="ksrq" value='<%=B_StoreAssistantMaterialCollectBean.getFixedQueryValue("ksrq")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" id="sfrq$b" style="WIDTH: 130px" name="jsrq" value='<%=B_StoreAssistantMaterialCollectBean.getFixedQueryValue("jsrq")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              <TD colspan="4" nowrap class="td" align="center">
                <% String qu = "sumitFixedQuery("+B_StoreAssistantMaterialCollectBean.FIXED_SEARCH+")";%>
                <INPUT class="button" onClick="sumitFixedQuery(<%=B_StoreAssistantMaterialCollectBean.FIXED_SEARCH%>)" type="button" value="查询(K)" name="button" onKeyDown="return getNextElement();">
