...
%>
<%
if(!loginBean.hasLimits("dept_assist_material_collect", request, response))
    return;
  engine.erp.store.xixing.B_DeptAssistantMaterialCollect B_DeptAssistantMaterialCollectBean = engine.erp.store.xixing.B_DeptAssistantMaterialCollect.getInstance(request);//得到实例(初始化实例变量)
  ...
  String retu = B_DeptAssistantMaterialCollectBean.doService(request, response);//src=../pub/main.jsp(初始化函数取值)
  ...
  RowMap[] xsdsrows = B_DeptAssistantMaterialCollectBean.getXsRowinfos();
  RowMap masterRow =B_DeptAssistantMaterialCollectBean.masterRow;
...
{
  location.href='dept_assist_material_collect_print.jsp';
}
//客户名称
...
<tr class="tableTitle">
    <td align="center" valign="middle" class="td" class="tdTitle" style="font-size:18">部门辅助材料领用汇总表</td>
</tr>
<tr>
...
<table id="tableview1" border="0" cellspacing="1" cellpadding="1" width="95%" align="center" class="table">
  <tr class="tableTitle">
    <td width="8%" rowspan="2" align="center" valign="middle" nowrap class="td">部门</td>
...
<%--    <td width="8%"  align="center" valign="middle" nowrap class="td">数量</td>
  ...
  %>
  <tr>
    <td class="td" nowrap><%=deptBean.getLookupName(xsrow.get("deptid"))%></td>
        ...
        <TD>
         <TABLE cellspacing=3 cellpadding=0 border=0>
           <TR>
              ...
              <TD class="td" nowrap>
               <INPUT class="edbox" style="WIDTH: 130px" name="ksrq" value='<%=B_DeptAssistantMaterialCollectBean.getFixedQueryValue("ksrq")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" id="sfrq$b" style="WIDTH: 130px" name="jsrq" value='<%=B_DeptAssistantMaterialCollectBean.getFixedQueryValue("jsrq")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <%=storeBean.getList(B_DeptAssistantMaterialCollectBean.getFixedQueryValue("storeid"))%></pc:select>
             </TD>
              <TD class="td" nowrap>部门</TD>
              <TD nowrap class="td"><pc:select name="deptid" addNull="1" style="width:160">
              <%=deptBean.getList(B_DeptAssistantMaterialCollectBean.getFixedQueryValue("deptid"))%></pc:select>
             </TD>
          </TR>
            <TR>
              <TD colspan="4" nowrap class="td" align="center">
                <% String qu = "sumitFixedQuery("+B_DeptAssistantMaterialCollectBean.FIXED_SEARCH+")";%>
                <INPUT class="button" onClick="sumitFixedQuery(<%=B_DeptAssistantMaterialCollectBean.FIXED_SEARCH%>)" type="button" value="查询(K)" name="button" onKeyDown="return getNextElement();">
