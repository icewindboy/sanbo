...
{
  ProdCodeChange(document.all['prod'], obj.form.name, 'srcVar=srcVar=sc_wjgjg$cpid&srcVar=sc_wjgjg$wjgjgid$cpbm&srcVar=product','fieldVar=cpid&fieldVar=cpbm&fieldVar=product', obj.value);
}
function productNameSelect(obj)
{
  ProdNameChange(document.all['prod'], obj.form.name, 'srcVar=srcVar=sc_wjgjg$cpid&srcVar=sc_wjgjg$wjgjgid$cpbm&srcVar=product','fieldVar=cpid&fieldVar=cpbm&fieldVar=product', obj.value);
}
</SCRIPT>
<%
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();">
  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    <tr class="tableTitle">
       <td height='20' align="center" width=45 nowrap><%if(loginBean.hasLimits(pageCode, op_add)){%><input name="image" class="img" type="image" title="新增(A)" onClick="showInterFrame(<%=Operate.ADD%>,-1)" src="../images/add.gif" border="0">
     ...
     <%corpBean.regData(list, "dwtxid");
       ...
       list.first();
       RowMap dwpRow =corpBean.getLookupRow(list.getValue("dwtxid"));
       int i=0;
...
<tr onDblClick="showInterFrame(<%=Operate.EDIT%>,<%=list.getRow()%>)">
    ...
    <%}%></td>
    <td class="td" nowrap><%=dwpRow.get("dwdm")%></td>
    ...
    <td class="td" nowrap><%=list.getValue("sftgmj").equals("1")?"是":"否"%></td>
    ...
    <td class="td" nowrap><%=list.getValue("bjrq")%></td>
    ...
    <TABLE cellspacing=3 cellpadding=0 border=0>
      <TR>
       ...
       <%--     <TR>
              ...
              <TD class="td" nowrap>
                 <input class="EDLine" style="WIDTH:130px" name="dwmc" value='<%=corpBean.getLookupName(b_ProcessPriceBean.getFixedQueryValue("sc_wjgjg$dwtxid"))%>' onKeyDown="return getNextElement();"readonly>
              ...
              <TR>
               <TD class="td" nowrap>原辅料名称编码</TD>
              <TD class="td" nowrap>
                  <INPUT class="edbox" style="WIDTH:70" id="sc_wjgjg$wjgjgid$cpbm" name="sc_wjgjg$wjgjgid$cpbm" value='<%=b_ProcessPriceBean.getFixedQueryValue("sc_wjgjg$wjgjgid$cpbm")%>' onchange="productCodeSelect(this)" onKeyDown="return getNextElement();">
                  <input class="EDbox" style="WIDTH:200px" name="product" value='<%=b_ProcessPriceBean.getFixedQueryValue("product")%>' onchange="productNameSelect(this)" onKeyDown="return getNextElement();"readonly>
                  <INPUT TYPE="HIDDEN" NAME="sc_wjgjg$cpid" value="<%=b_ProcessPriceBean.getFixedQueryValue("sc_wjgjg$cpid")%>">
                  <img style='cursor:hand' src='../images/view.gif' border=0 onClick="ProdSingleSelect('fixedQueryform','srcVar=sc_wjgjg$cpid&srcVar=product&srcVar=sc_wjgjg$wjgjgid$cpbm','fieldVar=cpid&fieldVar=product&fieldVar=cpbm',fixedQueryform.sc_wjgjg$cpid.value)">
                  <img style='cursor:hand' src='../images/delete.gif' BORDER=0 ONCLICK="sc_wjgjg$cpid.value='';product.value='';sc_wjgjg$wjgjgid$cpbm.value='';">
              </td>
            </TR>
           <%-- <TR>
            ...
            <tr>
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:70" name="sc_wjgjg$dfcph" value='<%=b_ProcessPriceBean.getFixedQueryValue("sc_wjgjg$dfcph")%>' maxlength='20' onKeyDown="return getNextElement();"></TD>
            </tr>
        <%--    <tr>
                 <td nowrap class='td'>历史报价</td>
                 <td nowrap class='td'colspan='3'>
                 <input type='radio' onKeyDown='return getNextElement()' name='CG_BJ$SFLSBJ' value='' checked>
                全部
                 <input type='radio' onKeyDown='return getNextElement()' name='CG_BJ$SFLSBJ' value='0'>
                否
                 <input type='radio' onKeyDown='return getNextElement()' name='CG_BJ$SFLSBJ' value='1'>
                是</td>
            </tr>--%>
          </TABLE>
      <TR>
...
<div class="queryPop" id="detailDiv" name="detailDiv">
  ...
  <TABLE cellspacing=0 cellpadding=0 border=0>
    <TR>
      <TD><iframe id="interframe1" src="" width="620" height="380" marginWidth="0" marginHeight="0" frameBorder="0" noResize scrolling="no"></iframe>
      </TD>
    </TR>
  </TABLE>
</div>
