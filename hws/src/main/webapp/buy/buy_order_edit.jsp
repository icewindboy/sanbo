...
%><%
  engine.erp.buy.B_BuyOrder buyOrderBean = engine.erp.buy.B_BuyOrder.getInstance(request);
            ...
            <td>
              <table CELLSPACING="1" CELLPADDING="1" BORDER="0" width="100%" bgcolor="#f0f0f0">
                ...
                <td noWrap class="tdTitle">单据号</td>
                  <td noWrap class="td"><input type="text" name="djh" value='<%=masterRow.get("djh")%>' maxlength='<%=ds.getColumn("djh").getPrecision()%>' style="width:100" <%=edClass%> onKeyDown="return getNextElement();" <%=masterReadonly%>></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
