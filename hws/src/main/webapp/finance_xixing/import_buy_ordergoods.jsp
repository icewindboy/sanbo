      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="jhdbm" name="jhdbm" value='<%=buyGoodsSelectBean.getFixedQueryValue("jhdbm")%>' maxlength='50' onKeyDown="return getNextElement();"></TD>
