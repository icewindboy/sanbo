    ...
    <TABLE cellspacing=3 cellpadding=0 border=0>
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="fphm" name="fphm" value='<%=b_SaleInvoiceBean.getFixedQueryValue("fphm")%>' maxlength='50' onKeyDown="return getNextElement();"></TD>
              <TD nowrap class="td">发票号码</TD>
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="sjhm" name="sjhm" value='<%=b_SaleInvoiceBean.getFixedQueryValue("sjhm")%>' maxlength='50' onKeyDown="return getNextElement();"></TD>
             </tr>
              <tr>
            ...
            <TR>
              ...
              <TD nowrap class="td">
                ...
                <%=invoiceTypeBean.getList(b_SaleInvoiceBean.getFixedQueryValue("fplbid"))%>
                </pc:select>
              </TD>
             </TR>
              <tr>
