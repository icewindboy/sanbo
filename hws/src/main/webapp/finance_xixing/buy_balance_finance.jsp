...
if(!loginBean.hasLimits(pageCode, request, response))
  ...
  engine.project.LookUp khyeBean = engine.project.LookupBeanFacade.getInstance(request, engine.project.SysConstant.VW_BEAN_BUY_YFKYE);
%>
<html>
<head>
<title></title>
...
{
    CustomerCodeChange('1',document.all['prod'], obj.form.name,'srcVar=dwdm&srcVar=dwtxid&srcVar=dwmc&srcVar=dfyh&srcVar=dfzh','fieldVar=dwdm&fieldVar=dwtxid&fieldVar=dwmc&fieldVar=khh&fieldVar=zh',obj.value,'sumitForm(<%=b_BuyBalanceBean.DWTXID_CHANGE%>,-1)');
}
//客户名称
function customerNameChange(obj)
{
    CustomerNameChange('1',document.all['prod'], obj.form.name,'srcVar=dwdm&srcVar=dwtxid&srcVar=dwmc&srcVar=dfyh&srcVar=dfzh','fieldVar=dwdm&fieldVar=dwtxid&fieldVar=dwmc&fieldVar=khh&fieldVar=zh',obj.value,'sumitForm(<%=b_BuyBalanceBean.DWTXID_CHANGE%>,-1)');
}
function deptchange(){
...
<%
  ...
  String khye = khyeBean.getLookupName(masterRow.get("dwtxid"));
                ...
                <%
                 ...
                 <tr>
                  ...
                  <td  noWrap colspan='3' class="td">
                    ...
                    <%if(!isEnd){%>
                    <img style='cursor:hand' src='../images/view.gif' border=0 onClick="ProvideSingleSelect('form1','srcVar=dwtxid&srcVar=dwmc&srcVar=dfyh&srcVar=dfzh&srcVar=dfdh&srcVar=dfcz','fieldVar=dwtxid&fieldVar=dwmc&fieldVar=khh&fieldVar=zh&fieldVar=tel&fieldVar=cz',form1.dwtxid.value,'sumitForm(<%=b_BuyBalanceBean.DWTXID_CHANGE%>,-1)');">
                    <%}%>
                  ...
                  <td noWrap class="td"><input type="text" name="je" value='<%=masterRow.get("je")%>' maxlength='<%=ds.getColumn("je").getPrecision()%>' style="width:110" <%=edClass%> onKeyDown="return getNextElement();" onchange="cjyf_onchange()"  <%=readonly%>></td>
                 </tr>
...
/*
  function selctTDHWOfLading()
  {
    ...
    TdhwMultiSelect('form1','srcVar=tdhwids','fieldVar=tdid',form1.dwtxid.value,"sumitForm(<%=b_BuyBalanceBean.DETAIL_SALE_ADD%>,-1)");
    }
*/
  function ViewCust()
  {
