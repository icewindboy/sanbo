...
<FRAMESET rows=*,153 cols="*" framespacing="3" frameborder="0" border="1" bordercolor="#f0f0e0">
  <FRAME name='top' src='buy_equipment_requisition_top.jsp?<%=query==null ? "" : query%>' scrolling="auto">
  <FRAME id="bottom" name='bottom' src=<%=operate != null && operate.equals(init) ? "../blank.htm" : "buy_equipment_requisition_bottom.jsp"%> scrolling="auto">
  <NOFRAMES>
  <body>
