...
<%
  ...
  synchronized(b_SaleExchangeBean){
    b_SaleExchangeBean.doService(request, response);
    EngineDataSet list = b_SaleExchangeBean.getDetailTable();
    HtmlTableProducer detailProducer = b_SaleExchangeBean.detailProducer;//从表表格生成器
    list.first();
...
<form name="form1" action="" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    <tr class="tableTitle">
      ...
      <td nowrap height='20'>退货产品编码</td>
      <td nowrap height='20'>退货品名</td>
    ...
    <%
      if(list.changesPending())
        b_SaleExchangeBean.openDetailTable(b_SaleExchangeBean.masterIsAdd());
