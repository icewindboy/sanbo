...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tablelx" width="600" border="0" cellspacing="1" cellpadding="1" align="center">
    <tr>
      ...
      <input name="lx" type="radio" value="<%=workbookBean.PERSON_POLITY%>" onClick="lx_onchange(this)"<%=type==workbookBean.PERSON_POLITY?" checked":""%>>政治面貌</td>
    </tr>
  </table><br>
  ...
  <script LANGUAGE="javascript">
    ...
    var url = "wordbookedit.jsp?operate="+oper+"&rownum="+rownum;
