...
%>
<%
  engine.erp.finance.ImportLadingProduct ImportLadingProductBean = engine.erp.finance.ImportLadingProduct.getInstance(request);
  ...
  String twldw=ImportLadingProductBean.dwtxid;
  String personid=ImportLadingProductBean.personid;
%>
<html>
<head>
<title></title>
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tableview1" width="90%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <tr <%if(!isMultiSelect){%>onDblClick="checkRadio(<%=i%>);selectCorp(<%=i%>);"<%}%>>
      ...
      <td nowrap align="center"  class="td" onClick="checkRadio(<%=i%>)"><%=list.getValue("zsje")%></td>
      <td nowrap align="center"  class="td" onClick="checkRadio(<%=i%>)"><%=list.getValue("je")%></td>
      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="tdbh" name="tdbh" value='<%=ImportLadingProductBean.getFixedQueryValue("tdbh")%>' maxlength='10' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>购货单位</TD>
              <TD nowrap class="td">
                <%if(twldw.equals("")){%>
                <input type="hidden" name="dwtxid" value='<%=ImportLadingProductBean.getFixedQueryValue("dwtxid")%>'>
                <input type="text" name="buyerName" value='<%=ImportLadingProductBean.getFixedQueryValue("buyerName")%>' style="width:130" class="edline" readonly>
            ...
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="tdrq$a" value='<%=ImportLadingProductBean.getFixedQueryValue("tdrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="tdrq$b" value='<%=ImportLadingProductBean.getFixedQueryValue("tdrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <%=deptBean.getList(ImportLadingProductBean.getFixedQueryValue("deptid"))%></pc:select>
              </TD>
              <TD class="td" nowrap>提单类型</TD>
              <TD nowrap class="td">
                <pc:select name="djlx" addNull="1" style="width:130" >
                <%=ImportLadingProductBean.listToOption(lists, opkey.indexOf(ImportLadingProductBean.getFixedQueryValue("djlx")))%>
               </pc:select>
              </TD>
             </TR>
            <TR>
