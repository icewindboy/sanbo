      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><input type="hidden" name="dwtxid" value='<%=select_LadingBill_ProductBean.getFixedQueryValue("dwtxid")%>'>
            ...
            <TR>
              ...
              <TD nowrap class="td">
                ...
                <%=select_LadingBill_ProductBean.listToOption(lists, opkey.indexOf(list.getValue("djlx")))%>
               </pc:select>
              </TD>
             </TR>
            <TR>
              ...
              <TD colspan="3" nowrap class="td">
                <%String zt = select_LadingBill_ProductBean.getFixedQueryValue("zt");%>
