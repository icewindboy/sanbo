...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tableview1" width="90%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    <tr class="tableTitle">
      <td class="td" nowrap align="center" ><input type='checkbox' name='checkform' onclick='checkAll(form1,this);'></td>
      <td nowrap>提单编号</td>
      <td nowrap>提单日期</td>
      <td nowrap>购货单位</td>
      <td nowrap>产品</td>
    ...
    <%
      ...
      for(; i<count; i++){
        ...
        zzsje = zzsje+Double.parseDouble(list.getValue("zsje").equals("")?"0":list.getValue("zsje"));
        zje = zje+Double.parseDouble(list.getValue("je").equals("")?"0":list.getValue("je"));
    %>
    ...
    %>
    <tr>
      <td class="td" nowrap>本页合计</td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td" nowrap><%=engine.util.Format.formatNumber(zzsje,"#0.00")%></td>
      <td class="td" nowrap><%=engine.util.Format.formatNumber(zje,"#0.00")%></td>
      <td class="td"></td>
     <td class="td"></td>
    </tr>
    <tr>
      <td class="td" nowrap>总合计</td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td"></td>
      <td class="td" nowrap><%=engine.util.Format.formatNumber(ImportLadingProductBean.zsje,"#0.00")%></td>
      <td class="td" nowrap><%=engine.util.Format.formatNumber(ImportLadingProductBean.zje,"#0.00")%></td>
      <td class="td"></td>
     <td class="td"></td>
    </tr>
    <%
