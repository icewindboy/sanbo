...
%>
<%
  engine.erp.finance.Select_Bill_Of_Lading select_Bill_Of_LadingBean = engine.erp.finance.Select_Bill_Of_Lading.getInstance(request);
  ...
  String retu = select_Bill_Of_LadingBean.doService(request, response);
  ...
  EngineDataSet list = select_Bill_Of_LadingBean.getOneTable();
  ...
  String twldw=select_Bill_Of_LadingBean.dwtxid;
%>
<html>
<head>
<title></title>
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();" >
  ...
  <table id="tableview1" width="90%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <tr <%if(!isMultiSelect){%>onDblClick="checkRadio(<%=i%>);selectCorp(<%=i%>);"<%}%>>
      ...
      <td nowrap align="center" id="khlx_<%=i%>" class="td" onClick="checkRadio(<%=i%>)"><%=list.getValue("khlx")%></td>
      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="tdbh" name="tdbh" value='<%=select_Bill_Of_LadingBean.getFixedQueryValue("tdbh")%>' maxlength='10' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>购货单位</TD>
              <TD nowrap class="td">
               <%if(twldw.equals("")){%>
               <input type="hidden" name="dwtxid" value='<%=select_Bill_Of_LadingBean.getFixedQueryValue("dwtxid")%>'>
                <input type="text" name="buyerName" value='<%=select_Bill_Of_LadingBean.getFixedQueryValue("buyerName")%>' style="width:130" class="edline" readonly>
            ...
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="tdrq$a" value='<%=select_Bill_Of_LadingBean.getFixedQueryValue("tdrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="tdrq$b" value='<%=select_Bill_Of_LadingBean.getFixedQueryValue("tdrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <%=deptBean.getList(select_Bill_Of_LadingBean.getFixedQueryValue("deptid"))%></pc:select>
              </TD>
              <TD class="td" nowrap>提单类型</TD>
              <TD nowrap class="td">
                <pc:select name="djlx" addNull="1" style="width:130" >
                <%=select_Bill_Of_LadingBean.listToOption(lists, opkey.indexOf(select_Bill_Of_LadingBean.getFixedQueryValue("djlx")))%>
               </pc:select>
              </TD>
             </TR>
            <TR>
