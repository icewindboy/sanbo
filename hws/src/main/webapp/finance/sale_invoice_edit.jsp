...
function selctbilloflading()
{
    ...
    OrderSingleSelect('form1','srcVar=selectedtdid','fieldVar=tdid&personid='+form1.personid.value,form1.dwtxid.value,"sumitForm(<%=b_SaleInvoiceBean.DETAIL_SALE_ADD%>,-1)");
}
