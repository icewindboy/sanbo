...
%>
<%
  engine.erp.finance.Select_Bill_Of_Stocking Select_Bill_Of_StockingBean = engine.erp.finance.Select_Bill_Of_Stocking.getInstance(request);
  ...
  String retu = Select_Bill_Of_StockingBean.doService(request, response);
  ...
  EngineDataSet list = Select_Bill_Of_StockingBean.getOneTable();
  ...
  String wldw=Select_Bill_Of_StockingBean.dwtxid;
%>
<html>
<head>
<title></title>
      ...
      <TR>
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH:160" id="jhdbm" name="jhdbm" value='<%=Select_Bill_Of_StockingBean.getFixedQueryValue("jhdbm")%>' maxlength='20' onKeyDown="return getNextElement();"></TD>
              <TD class="td" nowrap>供货单位</TD>
              <TD nowrap class="td">
                <%if(wldw.equals("")){%>
                <input type="hidden" name="dwtxid" value='<%=Select_Bill_Of_StockingBean.getFixedQueryValue("dwtxid")%>'>
                <input type="text" name="buyerName" value='<%=Select_Bill_Of_StockingBean.getFixedQueryValue("buyerName")%>' style="width:130" class="edline" readonly>
            ...
            <TR>
              ...
              <TD nowrap class="td"><INPUT class="edbox" style="WIDTH: 130px" name="jhrq$a" value='<%=Select_Bill_Of_StockingBean.getFixedQueryValue("jhrq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="jhrq$b" value='<%=Select_Bill_Of_StockingBean.getFixedQueryValue("jhrq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              ...
              <%=deptBean.getList(Select_Bill_Of_StockingBean.getFixedQueryValue("deptid"))%></pc:select>
              </TD>
              <TD class="td" nowrap>提单类型</TD>
              <TD nowrap class="td">
                <pc:select name="djlx" addNull="1" style="width:130" >
                <%=Select_Bill_Of_StockingBean.listToOption(lists, opkey.indexOf(Select_Bill_Of_StockingBean.getFixedQueryValue("djlx")))%>
               </pc:select>
              </TD>
             </TR>
            <TR>
