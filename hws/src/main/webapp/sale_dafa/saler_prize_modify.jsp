...
if(!loginBean.hasLimits("saler_prize", request, response))
    return;
  engine.erp.sale.dafa.B_SalerPrizeDetail B_SalerPrizeDetailBean  =  engine.erp.sale.dafa.B_SalerPrizeDetail.getInstance(request);
%>
...
<%
  ...
  //EngineDataSet ds = B_SalerPrizeDetailBean.getDetailTable();
  RowMap row = B_SalerPrizeDetailBean.getDetailRow();
   ...
   <tr>
    ...
    <tr>
      <td colspan="2" noWrap class="tableTitle"><br>
        <%
          String ss= "sumitForm("+B_SalerPrizeDetailBean.DETAIL_POST+");";
         %>
