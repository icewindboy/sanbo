  ...
  <table id="tableview1" width="95%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <%
      ...
      for(; i<list.getRowCount(); i++){
        ...
        BigDecimal wkds = new BigDecimal(list.getValue("sl").equals("")?"0":list.getValue("sl"));
        wkds = wkds.subtract(new BigDecimal(list.getValue("skdsl").equals("")?"0":list.getValue("skdsl")));
    %>
    <tr onclick="checkTr(<%=i%>)">
      ...
      <td nowrap onClick="checkRadio(<%=i%>)" id="sl_<%=i%>" class="td"><%=wkds%></td>
