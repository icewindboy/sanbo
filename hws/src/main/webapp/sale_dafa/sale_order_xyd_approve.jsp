...
<%String retu = saleOrderBean.doService(request, response);
  ...
  RowMap xyedRow = saleOrderBean.getXYED(dwtxid);
...
<table  width="750" border="0" cellspacing="1" cellpadding="1"  align="center">
  ...
  <tr>
    ...
    <td noWrap class="td"><input type="text" name="xyde" value='<%=xyedRow.get("xyed")%>' style="width:100" class="edline" readonly></td>
    <td noWrap class="tdTitle">回笼天数</td>
    <td noWrap class="td"><input type="text" name="hkts" value='<%=xyedRow.get("hlts")%>' style="width:100" class="edline" readonly></td>
    <td noWrap class="tdTitle">信誉度余额</td>
    <td noWrap class="td"><input type="text" name="xyde" value='<%=xyedRow.get("kyxyed")%>' style="width:100" class="edline" readonly></td>
  </tr>
  <tr>
