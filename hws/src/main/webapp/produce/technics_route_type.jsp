...
<SCRIPT LANGUAGE="javascript">
  ...
  function showInterFrame(oper, rownum){
   var url = "technics_route_typeedit.jsp?operate="+oper+"&rownum="+rownum;
...
<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0 CLASS="headbar">
  <TR>
    <TD colspan="6" align="center" NOWRAP>工艺路线类型设置</TD>
  </TR>
</TABLE>
<%out.print(retu);
  EngineDataSet list = b_TechnicsRouteTypeBean.getOneTable();
...
<form name="form1" method="post" action="<%=curUrl%>" onsubmit="return false;" onKeyDown="return onInputKeyboard();">
  ...
  <TABLE WIDTH="90%" BORDER=0 CELLSPACING=0 CELLPADDING=0 align="center">
    ...
    <td class="td" nowrap>
     <%String key = "ppdfsgg"; pageContext.setAttribute(key, list);
      ...
      <TD align="right"><%if(b_TechnicsRouteTypeBean.retuUrl!=null){%><input name="button2222232" type="button" align="Right"
  class="button" onClick="location.href='<%=b_TechnicsRouteTypeBean.retuUrl%>'" value=" 返回(C)"border="0">
  <% String back ="location.href='"+b_TechnicsRouteTypeBean.retuUrl+"'" ;%>
  ...
  <table id="tableview1" width="90%" border="0" cellspacing="1" cellpadding="1" class="table" align="center">
    ...
    <tr onDblClick="showInterFrame(<%=Operate.EDIT%>,<%=list.getRow()%>)">
      ...
      <%}%></td>
      <td class="td"><%=list.getValue("gylxlxbh")%></td>
      <td class="td"><%=list.getValue("gylxlxmc")%></td>
    </tr>
    <%  list.next();
      }
...
<div class="queryPop" id="detailDiv" name="detailDiv">
  ...
  <TABLE cellspacing=0 cellpadding=0 border=0>
    <TR>
      <TD><iframe id="interframe1" src="" width="280" height="150" marginWidth="0" marginHeight="0" frameBorder="0" noResize scrolling="no"></iframe>
      </TD>
    </TR>
  </TABLE>
</div>
