        ...
        <TD> <TABLE cellspacing=3 cellpadding=0 border=0>
         ...
         <%=workShopBean.getList(produceProcessBean.getFixedQueryValue("deptid"))%></pc:select>
           ...
           <TR>
              ...
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH: 130px" name="rq$a" value='<%=produceProcessBean.getFixedQueryValue("rq$a")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
              ...
              <TD class="td" nowrap><INPUT class="edbox" id="rq$b" style="WIDTH: 130px" name="rq$b" value='<%=produceProcessBean.getFixedQueryValue("rq$b")%>' maxlength='10' onChange="checkDate(this)" onKeyDown="return getNextElement();">
            ...
            <TR>
              <TD align="center" nowrap class="td">产品名称</TD>
               <td nowrap class="td" colspan="3"><input class="EDLine" style="WIDTH:330px" name="product" value='<%=produceProcessBean.getFixedQueryValue("product")%>' onKeyDown="return getNextElement();"readonly>
                <INPUT TYPE="HIDDEN" NAME="jgdid" value="<%=produceProcessBean.getFixedQueryValue("jgdid")%>"><img style='cursor:hand' src='../images/view.gif' border=0 onClick="ProdSingleSelect('fixedQueryform','srcVar=jgdid&srcVar=product','fieldVar=cpid&fieldVar=product',fixedQueryform.jgdid.value)">
               <img style='cursor:hand' src='../images/delete.gif' BORDER=0 ONCLICK="jgdid.value='';product.value='';">
            </td>
            </TR>
             <TR>
              <TD class="td" nowrap>产品编码</TD>
              <TD class="td" nowrap><INPUT class="edbox" style="WIDTH:130" id="jgdid$cpbm" name="jgdid$cpbm" value='<%=produceProcessBean.getFixedQueryValue("jgdid$cpbm")%>' onKeyDown="return getNextElement();"></TD>
