...
%><%
  engine.erp.produce.B_Plan_Singlesel_Saleorder singleSelectSaleOrderBean = engine.erp.produce.B_Plan_Singlesel_Saleorder.getInstance(request);
  String pageCode = "produce_plan";
  if(!loginBean.hasLimits(pageCode, request, response))
    return;
  String retu = singleSelectSaleOrderBean.doService(request, response);
  ...
  EngineDataSet list = singleSelectSaleOrderBean.getOneTable();
%>
<html>
<head>
<title></title>
