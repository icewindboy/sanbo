...
%><%
  ...
  workloadDeptBean.doService(request, response);
  EngineDataSet list = workloadDeptBean.getDetailTable();
  synchronized(list){
    if(list.changesPending())
      workloadDeptBean.openDetailTable(false);
    ...
    //engine.project.LookUp salePriceBean = workloadDeptBean.getSalePriceBean(request);
%>
<html>
<head>
<title></title>
