...
{
  if(djlx==1)
  paraStr = "../sale/lading_bill_edit.jsp?operate=645355666&code=lading_bill&id="+id;
  else
    paraStr = "../sale/back_lading_bill_edit.jsp?operate=645355666&code=lading_bill&id="+id;
